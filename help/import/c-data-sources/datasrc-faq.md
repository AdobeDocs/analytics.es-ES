...
## ¿Cómo se pueden conectar datos sin conexión con eventos en línea? {#offline}
...
## ¿Cuánto cuesta utilizar la opción de fuente de datos? {#cost}
...
## ¿Cómo se pueden incluir comentarios en los archivos de fuente de datos?  {#comments}

Cada fila del archivo de fuente de datos que comience con un signo de almohadilla (#) se considera un comentario.

## ¿Es necesario incluir una columna de fecha en los datos de la hoja de cálculo? {#date}
...
## ¿Se pueden almacenar datos en variables que ya se están utilizando?  {#variables}
...
## ¿Se pueden eliminar los datos importados mediante fuentes de datos? {#imported}
...
## ¿Cuántos datos se pueden importar a la vez? {#amount}
...
## Cuando se importan datos a través de fuentes de datos, ¿se sobrescriben los datos ya presentes? {#overwrite}
...
## Cuando se cargan datos por medio de fuentes de datos, ¿por qué no aparecen también las métricas? {#metrics}
...
## ¿Qué sucede si se transmiten valores negativos a informes a través de fuentes de datos?  {#negative}

El valor disminuye según corresponda.

## ¿Qué diferencia hay entre una fuente de datos (genérica) de conversión y una de tráfico? {#traffic}
...
## ¿El sistema de fuentes de datos tiene en cuenta las subrelaciones, las correlaciones y la información sobre rutas? {#breakdown}
...
## En las cargas de fuentes de datos o en los archivos de clasificación, ¿la extensión de archivo distingue entre mayúsculas y minúsculas? {#case}
...
## ¿Se pueden agregar otros eventos a la plantilla generada o no se puede pasar de tres?  {#template}
...
## ¿Qué ocurre si en un archivo de fuente de datos hay registros que no tienen la misma cantidad de columnas que el registro de encabezado? {#header}
...
## ¿La información de las fuentes de datos se resume? {#rollup}
...
## ¿Por qué en el informe de vistas de página no se muestran datos de la fuente de datos para un día particular, pero sí se muestran los datos correctos para una semana? {#week}
...
## ¿Cómo se calculan los visitantes únicos en las cargas de fuente de datos de registros de servidor web? {#unique}
...
## En el sistema de fuentes de datos, ¿cómo se puede saber qué usuario corresponde a cada grupo de informes? {#login}
...
## ¿Cuál es el efecto que tienen la versión 15 y la segmentación en las fuentes de datos?  {#segmentation}
...
## ¿Las métricas que se importan con un ID de transacción están disponibles en fuentes de datos del flujo de navegación y en Data Warehouse? {#clickstream}
...
## ¿Las eVars que continúan en este momento en el perfil del visitante se asignan a métricas cargadas mediante fuentes de datos? {#visitor}
...
## ¿Las eVars cargadas mediante fuentes de datos continúan en el comportamiento en Internet posterior? {#evars}
...
## ¿Cómo funcionan los eventos numéricos y monetarios con las fuentes de datos? {#numeric}
