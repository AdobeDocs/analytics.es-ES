...
seo-description: Las siguientes métricas se sincronizan como parte de la integración de appfigures.
...
| Compras de App Store (en aplicación) | Número de compras desde la propia aplicación. |
| Clasificación de App Store | Se utiliza para definir la métrica calculada appfigures promedio. No se utiliza directamente. |
| Divisor de la clasificación de App Store | Se utiliza para definir la métrica calculada appfigures promedio. No se utiliza directamente. |
| Clasificación de App Store | Se utiliza para definir la métrica calculada appfigures promedio. No se utiliza directamente. |
| Divisor de la clasificación de App Store | Se utiliza para definir la métrica calculada appfigures promedio. No se utiliza directamente. |
| Ingresos de App Store (en la aplicación) | El importe de los ingresos dentro de la aplicación. |
| Ingresos de App Store (uno desactivado) | El importe de los ingresos asociados con la compra de una aplicación. |
| Derechos de autor de App Store (en aplicación) | Obsoleto. |
| Derechos de autor de App Store (uno desactivado) | Obsoleto. |

El asistente de Conectores de datos crea las siguientes dimensiones de clasificación reservadas para la evar reservada de ID de objeto appfigures.

| Dimensión de clasificación | Descripción |
|---|---|
| Nombre del país | El nombre del país relacionado con la actividad del almacén de aplicaciones. |
| Nombre del dispositivo | El nombre del dispositivo móvil relacionado con la actividad del almacén de aplicaciones. |
| Nombre de la tienda | Nombre del appstore que informó la actividad. |
| Nombre de aplicación | Nombre de la aplicación móvil. |
| Nombre en la aplicación | Elemento comprado dentro de la aplicación. |
...
| Revisar comentario | Comentario de la revisión |
...
La siguiente métrica calculada se crea mediante el asistente de Conectores de datos:

<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Métrica calculada </th> 
   <th colname="col2" class="entry"> Descripción </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> Clasificación promedio de App Store (numérico) </td> 
   <td colname="col2"> <p>La clasificación media de la aplicación. Esta métrica calculada se define con la siguiente fórmula: </p> <code> [Aplicación y amp; nbsp; Store &amp; amp; nbsp; Clasificación] &amp; amp; nbsp; /&amp; amp; nbsp; [Aplicación y amp; nbsp; Store &amp; amp; nbsp; Clasificación y amp; nbsp; Divisor] </code> <p>Nota: El número de aplicaciones clasificado por categoría y país varía entre las tiendas de aplicaciones. Si la aplicación es inferior a este umbral, las clasificaciones de la aplicación no están disponibles. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Puntuación media de la tienda de aplicaciones </td> 
   <td colname="col2"> La clasificación media de la aplicación. Esta métrica calculada se define con la fórmula siguiente: <code> [Aplicación y amp; nbsp; Store &amp; amp; nbsp; Clasificación] &amp; amp; nbsp; /&amp; amp; nbsp; [Aplicación y amp; nbsp; Store &amp; amp; nbsp; Clasificación y amp; nbsp; Divisor] </code> </td> 
  </tr> 
 </tbody> 
</table>
...
La tabla siguiente muestra qué dimensiones de informes se relacionan con las métricas.
...
<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col9"> Ingresos de App Store (una desactivación) </td> 
   <td colname="col10"> Clasificación promedio de AppStore </td> 
   <td colname="col11"> Clasificación media de App Store </td> 
  </tr> 
  <tr> 
