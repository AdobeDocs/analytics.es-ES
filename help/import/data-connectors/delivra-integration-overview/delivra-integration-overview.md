...
* **** Cuenta de Delivra válida: Para utilizar la integración de correo electrónico de Data Connectors, un cliente debe tener una cuenta de Delivra válida.
