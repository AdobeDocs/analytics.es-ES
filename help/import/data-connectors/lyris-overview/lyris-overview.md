---
description: Describe las eficiencias de mercadotecnia logradas mediante la integración.
seo-description: Describe las eficiencias de mercadotecnia logradas mediante la integración.
seo-title: Conector de datos Lyris para Adobe Analytics
solution: Analytics
...
Describe las eficiencias de mercadotecnia logradas mediante la integración.

La integración de correo electrónico de Adobe® Data Connectors™ combina la información de comportamiento de Adobe Analytics con la mercadotecnia de correo electrónico de Lyris para redefinir la medición de éxito y las audiencias objetivo con mensajes más relevantes.
...
Esta integración requiere que se reserven al menos 2 eVars para cada implementación de grupo de informes. Aparte de estas eVars, es posible que se reserven algunos eventos según los datos de Lyris que desee ver en Analytics. Estas eVars y eventos se describen en la tabla siguiente:
