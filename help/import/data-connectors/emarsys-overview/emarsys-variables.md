...
Después de identificar el evento y las evars que se van a utilizar con la integración de Emarsys, habilítelos en [Admin Console](https://microsite.omniture.com/t2/help/en_US/reference/index.html?f=conversion_var_admin).
