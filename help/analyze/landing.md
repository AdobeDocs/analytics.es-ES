...
| --- | --- | --- |
| Expandir [!UICONTROL Proyectos] tabla a pantalla completa | Para expandir la tabla, haga clic en el icono de menú hamburguesa. Esta acción contraerá las pestañas del carril izquierdo. | ![Expandir tabla](assets/landing-collapse.png) |
| Personalizar anchura de columna | Anteriormente, el ancho de la columna era fijo. Ahora puede ajustarlo arrastrando el separador de columnas. |  |
...
| Nuevas columnas de tabla | Haga clic en el [!UICONTROL Personalizar tabla] en la parte superior derecha de la tabla. Las nuevas columnas de la tabla incluyen: <ul><li>**[!UICONTROL Programado]**: Establecer como [!UICONTROL Activado] cuando un proyecto está programado o [!UICONTROL Off] cuando no lo sea. Al hacer clic en [!UICONTROL Activado] link permite ver información sobre el proyecto programado. También puede [editar la programación del proyecto](/help/analyze/analysis-workspace/curate-share/t-schedule-report.md) si es el propietario del proyecto.</li><li>**[!UICONTROL ID del proyecto]**: El ID de proyecto se puede usar para depurar proyectos.</li><li>**[!UICONTROL Intervalo de fechas más largo]**: Los intervalos de fechas más largos aumentan la complejidad del proyecto y pueden aumentar los tiempos de procesamiento y carga. </li><li>**[!UICONTROL Número de consultas]**: Un número mayor de consultas de proyectos aumenta la complejidad del proyecto y puede aumentar los tiempos de procesamiento y carga.</li></ul> | ![Nuevas columnas](assets/new-columns.png) |
| Un solo clic para abrir un informe | Anteriormente, se tenía que hacer doble clic. |  |
| Nuevos vínculos a **[!UICONTROL Informes y análisis]** informes | <ul><li>**[!UICONTROL Informes]** > **[!UICONTROL Audiencia]** > **[!UICONTROL Bots]**</li><li>**[!UICONTROL Informes]** > **[!UICONTROL Audiencia]** > **[!UICONTROL Páginas de bots]**<li>**[!UICONTROL Informes]** > **[!UICONTROL Participación]** > **[!UICONTROL Tiempo real]**</li></ul> | ![Nuevos vínculos](assets/report-links.png) |
| Nuevos informes predeterminados | <ul><li>**[!UICONTROL Informes]** > **[!UICONTROL Más popular]** > **[!UICONTROL Página siguiente]**</li><li>**[!UICONTROL Informes]** > **[!UICONTROL Más popular]** > **[!UICONTROL Página anterior]**</li><li>**[!UICONTROL Informes]** > **[!UICONTROL Participación]** > **[!UICONTROL Análisis de página]** > **[!UICONTROL Resumen de la página]**</li></ul>Tenga en cuenta que estos informes se encuentran en [!UICONTROL Espacio de trabajo] y requieren configuración y compilación. El resultado consiste en un panel de métricas de alto nivel, datos de tendencias, [!UICONTROL Flujo] visualización, etc. Puede modificar estos informes y cambiar dimensiones, elementos de dimensión, etc. Estos informes también están disponibles como paneles en los paneles de Workspace. | ![Página siguiente](assets/next-page.png) |
| **[!UICONTROL Crear nuevo]** el modal vuelve | Al hacer clic en **[!UICONTROL Crear nuevo]** en Workspace, una vez más puede elegir entre una [!UICONTROL Proyecto en blanco] y [!UICONTROL Informe de valoración móvil en blanco]. También puede elegir entre cualquier plantilla que haya creado su empresa. | ![Crear nueva](assets/create-new.png) |
| También disponible en CJA | Esta página de aterrizaje, en un formulario modificado, también estará disponible en CJA. |  |
...
* **[!UICONTROL Plantillas]** ya no se usa como término para los proyectos del Espacio de trabajo generados previamente por Adobe. Ahora se encuentran en [!UICONTROL Informes]. El término [!UICONTROL Plantillas] se sigue utilizando para plantillas creadas por su empresa.
...
| [!UICONTROL Crear proyecto] | El menú desplegable permite crear un [!UICONTROL proyecto del Espacio de trabajo] o un [!UICONTROL proyecto móvil]. |
...
| Pregunta | Respuesta |
| --- | --- |
| ¿Dónde están las plantillas que estoy acostumbrado a ver en [!UICONTROL Espacio de trabajo]? | Esas plantillas se agrupan en la pestaña [!UICONTROL Informes]. |
| ¿Puedo excluirme de la versión beta? | Puede excluirse de la versión beta en cualquier momento. |
| ¿El trabajo que hago en la interfaz de usuario del programa beta se transfiere a la producción? [!UICONTROL Espacio de trabajo] experiencia? | Sí, cualquier trabajo realizado en la versión beta se transfiere a la versión antigua/actual [!UICONTROL Espacio de trabajo] experiencia. |
| Son mis actuales [!DNL Reports & Analytics] favoritos arrastrados? | No, NO se transfieren. Sin embargo, cualquier [!UICONTROL Espacio de trabajo] los favoritos del proyecto se transfieren. |
