---
description: Explica cómo la página de aterrizaje aúna tanto Analysis Workspace como Reports & Analytics en una sola interfaz y punto de acceso bajo el paraguas de Workspace.
...
La página de aterrizaje para Adobe Analytics reúne tanto Analysis Workspace como Reports &amp; Analytics en una sola interfaz y punto de acceso bajo el paraguas de Workspace. Incluye una página de inicio del administrador de proyectos, un menú de informes actualizado, informes modernizados y una sección de aprendizaje para ayudarle a empezar de forma más eficaz.
...
Después de iniciar sesión en Adobe Experience Cloud y Analytics, active el botón de alternancia [!UICONTROL Nueva página de aterrizaje - Beta] en la esquina inferior izquierda. El acceso al botón de alternancia es específico del usuario por organización, no por empresa.
...
* Menú Análisis principales: La mayoría de los informes se encuentran ahora en el menú [!UICONTROL Reports] en el carril izquierdo.
...
| Mostrar menos/más | Alterna entre no mostrar y mostrar el banner: ![Banner superior](assets/top-banner.png) |
...
| Icono de anclaje | Puede fijar elementos y éstos *siempre* aparecen en la parte superior de la lista. |
...
![Ficha Informes](assets/reports-tab.png)
...
| **[!UICONTROL Informes de la compañía]** | Informes que su compañía ha creado para su uso. |
