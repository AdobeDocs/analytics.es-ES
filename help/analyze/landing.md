...
| --- | --- | --- |
| Expandir [!UICONTROL Proyectos] tabla a pantalla completa | Para expandir la propiedad inmobiliaria de la tabla, simplemente haga clic en el icono de menú hamburguesa. Esta acción contraerá las pestañas del carril izquierdo. | ![Expandir tabla](assets/landing-collapse.png) |
...
| Nuevos vínculos a informes de Reports &amp; Analytics | <ul><li>Informes > Audiencia > Bots</li><li>Informes > Audiencia > Páginas de bots<li>Informes > Participación > Tiempo real</li></ul> | ![Nuevos vínculos](assets/report-links.png) |
| Nuevos informes predeterminados | <ul><li>Informes > Más populares > Página siguiente</li><li>Informes > Más populares > Página anterior</li><li>Informes > Participación > Análisis de página > Resumen de página</li></ul>Tenga en cuenta que estos informes están en formato de Workspace y requieren configuración y creación. El resultado consiste en un panel de métricas de alto nivel, datos de tendencias, [!UICONTROL Flujo] visualización, etc. También puede modificar estos informes y cambiar dimensiones, elementos de dimensión, etc. Estos informes también están disponibles como paneles en los paneles de Workspace. | ![Página siguiente](assets/next-page.png) |
| [!UICONTROL Crear nuevo] el modal vuelve | Al hacer clic en [!UICONTROL Crear nuevo] en Workspace, una vez más, puede elegir entre un proyecto en blanco y un informe de valoración móvil en blanco. También puede elegir entre cualquier plantilla que haya creado su empresa. | ![Crear nueva](assets/create-new.png) |
