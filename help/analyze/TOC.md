...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Componentes {#components}
      ...
      + Calendario e intervalos de fechas {#calendar-date-ranges}
         ...
         + [Comparar fechas afectadas por un evento](analysis-workspace/components/calendar-date-ranges/compare-event.md)
...
+ dashboards {#mobapp}
   + [Información general sobre paneles](mobile-app/home.md)
