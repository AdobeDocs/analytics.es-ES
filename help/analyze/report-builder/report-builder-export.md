...
1. Si aún no lo ha hecho, configure una cuenta y una ubicación de exportación, tal como se describe en [Configuración de cuentas de exportación en la nube](/help/components/locations/configure-import-accounts.md).
...
1. En el panel derecho de [!UICONTROL **Adobe Report Builder**], especifique la siguiente información para continuar creando una nueva programación:
   ...
   | **[!UICONTROL Anexar marca de tiempo al nombre de archivo]** | Seleccione esta opción para incluir una marca de tiempo de la exportación en el nombre del archivo exportado. |
   ...
   | **[!UICONTROL Correo electrónico]** | Seleccione esta opción para enviar el archivo a una dirección de correo electrónico específica. Para obtener más información acerca de esta opción, vea [Programar libros compartiéndolos por correo electrónico](/help/analyze/report-builder/schedule-reportbuilder.md). |
