...
1. Seleccione un bloque de datos en el Administrador de bloques de datos.
1. Haga clic en el icono de la papelera para eliminar el bloque de datos seleccionado.
