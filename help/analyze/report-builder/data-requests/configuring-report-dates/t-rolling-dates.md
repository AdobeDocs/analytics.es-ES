...
1. Haga clic en el vínculo **[!UICONTROL Móvil]** para seleccionar el tipo móvil y, a continuación, utilice los vínculos de fecha para configurar las fechas móviles.
   ...
   La configuración de las [!UICONTROL fechas móviles] cambia dependiendo de las selecciones realizadas. Por ejemplo, al seleccionar [!UICONTROL Móvil semanalmente], el Report Builder proporciona ajustes específicos de la semana que puede seleccionar como patrón móvil.
