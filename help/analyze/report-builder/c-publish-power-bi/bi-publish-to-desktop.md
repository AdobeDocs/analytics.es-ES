...
1. Habilite **[!UICONTROL Conexión dinámica al Servicio de Power BI]** y haga clic en **[!UICONTROL Aceptar]**. ![Haga clic en Conexión dinámica de Power BI Service y, a continuación, en Aceptar. ](assets/bi-preview-features.png)
...
Para obtener más información, consulte [Publicación de blog de Microsoft](https://powerbi.microsoft.com/en-us/blog/connecting-to-datasets-in-the-power-bi-service-from-desktop/).
