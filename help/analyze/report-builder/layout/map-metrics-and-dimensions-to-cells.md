...
El número de áreas y celdas que se van a asignar difiere según la métrica que seleccione, la granularidad, el intervalo de fechas y los filtros que defina. Por ejemplo, si selecciona [!UICONTROL Métrica del sitio] > [!UICONTROL Informe de tráfico], configurado [!UICONTROL Semana] granularidad y establezca el intervalo de fechas para la variable [!UICONTROL Últimas 2 semanas], se le pedirá que asigne tres celdas (al utilizar [!UICONTROL Diseño personalizado]) en el [!UICONTROL Asistente para solicitudes: Paso 2]. La solicitud recupera los datos de la semana uno y de la semana dos, donde cada valor de punto de datos es igual al valor de una vista de página. La tercera celda sirve como encabezado de fila, que se puede configurar utilizando [!UICONTROL Opciones de formato].
...
Haga clic en el **[!UICONTROL Selector de rango]** ![select_cell_icon.png](assets/select_cell_icon.png) situado junto al elemento que desee asignar.
...
Si elige asignar por error a una celda que ya tiene una asignación activa, no aparecerá ninguna referencia de celda en el cuadro de texto situado junto al icono de selección de rango. Al hacer clic en [!UICONTROL OK], el Report Builder muestra el error, *El rango seleccionado se cruza con el rango de otra solicitud. Cambie su selección.*
