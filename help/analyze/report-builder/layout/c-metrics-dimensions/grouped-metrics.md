...
Las métricas de tráfico y comercio se muestran en la misma categoría de métrica en el Asistente para solicitudes: Paso 2. La categoría agrupada se denomina **[!UICONTROL Standard]**.

![Captura de pantalla del Asistente para solicitudes: Lista de métricas estándar del paso 2.](assets/standard_metrics.png)
