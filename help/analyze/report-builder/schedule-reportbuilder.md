...
## Administrar libros programados heredados

Para obtener información acerca de la administración de libros de trabajo heredados que ya están programados, vea [Convertir libros programados](/help/analyze/report-builder/convert-workbooks.md#schedule-a-converted-legacy-workbook).
