...
seo-title: Informes de dispositivos móviles
...
<table id="table_8862E941EF5A41EFB0E7FADEEA86C37D"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Informe de tamaño de pantalla </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>Informe de ancho de pantalla </p> </td> 
  ...
  <tr> 
   <td colname="col1"> Informe de sistema operativo </td> 
  ...
  <tr> 
   <td colname="col1"> Informe de longitud de la dirección URL del correo electrónico </td> 
  ...
  <tr> 
   <td colname="col1"> Informe de servicios de información </td> 
   <td colname="col2"> <p>Agrupa los dispositivos móviles según los servicios de noticias (Canal I/B, EZ News Flash, W+INFO, etc.) que admiten. Si un visitante utiliza un dispositivo móvil con servicios de noticias para obtener acceso al sitio, el informe de servicios de información se incrementa por lo menos en uno. Si el teléfono admite varios servicios de noticias, se incrementa cada uno de los grupos del informe. Por lo tanto, la suma de los grupos puede ser mayor que el total que aparece al final del informe. </p> </td> 
  </tr> 
 </tbody> 
</table>
