...
seo-description: Utilice el administrador de tableros para copiar, compartir, archivar y programar tableros para su envío.
seo-title: Administrador de tableros
solution: Analytics
subtopic: Tableros
