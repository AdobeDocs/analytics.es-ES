...
Puede usar el calendario para ejecutar comparaciones de fechas entre los informes de clasificación.
...
Puede especificar si desea mostrar el porcentaje como un gráfico en una tabla de informe.
...
Puede ejecutar informes en un día específico de la semana, (por ejemplo, cada lunes), en un intervalo de fechas determinado.
...
Para ejecutar un informe de día de semana:
