...
*Este artículo documenta las visualizaciones de áreas y áreas apiladas en **Adobe Analytics**.<br/>Ver [Área y área apilada](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/area) para la versión de **Customer Journey Analytics**de este artículo.*
