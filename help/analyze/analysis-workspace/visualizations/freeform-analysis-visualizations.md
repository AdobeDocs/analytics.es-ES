...
| [Flujo](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md) | Muestra las rutas exactas del cliente en sus sitios web y aplicaciones. |
...
| [Histograma](/help/analyze/analysis-workspace/visualizations/histogram.md) | Un histograma agrupa a visitantes, visitas o visitas individuales en bloques en función de un volumen de métrica. |
...
| Granularidad | En las visualizaciones de tendencias, puede cambiar la granularidad de tiempo (día, semana, mes, etc.) de esta lista desplegable. Este cambio también se aplica a la tabla de origen de datos. |
| Porcentajes | Muestra valores en porcentajes. |
| Apilada al 100 % | Esta configuración en las visualizaciones de áreas apiladas, barras apiladas o barras horizontales apiladas convierte el gráfico en una visualización apilada al 100 %. Ejemplo: ![Apilado 100%](assets/stacked_100_percent.png) |
| Leyenda visible | Permite ocultar el texto detallado del pie de ilustración para la visualización Número de resumen/Cambio de resumen . |
...
Además, puede cambiar el nombre de las etiquetas de leyenda para que los elementos visuales sean más legibles. Nota: la edición de leyenda **not** se aplica a: Visualizaciones de diagrama de rectángulos, viñeta, número/cambio de resumen, texto, forma libre, histograma, cohorte o flujo.
...
Hay funcionalidades adicionales para una visualización disponibles haciendo clic con el botón derecho en el encabezado de visualización. La configuración variará según la visualización. Algunos de los ajustes disponibles son:
...
| Copiar visualización | Le permite hacer clic con el botón derecho y copiar una visualización, de modo que pueda insertarla en otro lugar dentro del proyecto o en un proyecto completamente diferente. |
...
| [Descargue los datos como CSV](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/download-send.html?#download-data) | Descargue la fuente de datos de visualización como CSV. |
...
| Obtener vínculo de visualización | Le permite dirigir a alguien a una visualización específica dentro de un proyecto. Cuando se hace clic en el vínculo, se requiere que el destinatario inicie sesión antes de ser dirigido a la visualización exacta vinculada. |
