...
La función de flujo muestra las rutas de los clientes a través de los sitios web y las aplicaciones.
...
> [!NOTE] Para obtener información sobre cómo pueden diferir los resultados de aplicar segmentos a Flujo entre Analysis Workspace e Informes y análisis/Análisis específicos, consulte [Segmentación como base para Flujo y Visitas en el orden previsto](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md).
