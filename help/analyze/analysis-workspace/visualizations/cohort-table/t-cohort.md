...
1. En Analysis Workspace, haga clic en el icono **[!UICONTROL Visualizaciones]** en el panel izquierdo y, a continuación, arrastre una **[!UICONTROL tabla de cohorte]** al lienzo.

   ![](assets/cohort-table.png)

1. Defina los **[!UICONTROL Criterios de inclusión]**, **[!UICONTROL Criterios de retorno]**, el **[!UICONTROL Tipo de cohorte]** y la **[!UICONTROL Configuración]** tal y como se indica en la siguiente tabla.
...
1. Para ajustar la configuración de la **[!UICONTROL tabla de cohorte]**, haga clic en el icono de engranaje.
...
1. En el [Generador de segmentos](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_build.html), continúe editando el segmento y luego haga clic en **[!UICONTROL Guardar]**.
