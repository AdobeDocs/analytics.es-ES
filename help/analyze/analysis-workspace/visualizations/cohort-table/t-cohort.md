...
1. (Opcional) Ajuste la variable **[!UICONTROL Configuración de tabla de cohorte]** haciendo clic en el icono de engranaje.
...
Al igual que otras visualizaciones de Analysis Workspace, puede descargar una visualización de cohorte como archivo CSV o PDF. Para obtener más información, consulte [Descargar archivos PDF o CSV](/help/analyze/analysis-workspace/curate-share/download-send.md).
