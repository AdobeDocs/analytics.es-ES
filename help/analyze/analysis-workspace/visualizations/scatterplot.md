...
La visualización ![GraphScatter](/help/assets/icons/GraphScatter.svg) **[!UICONTROL Dispersión]** muestra la relación entre los elementos de dimensión y hasta tres métricas. La visualización requiere tres componentes y admite la visualización de hasta cuatro componentes.
...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Visualización de diagrama de dispersión](https://video.tv.adobe.com/v/334459/?quality=12){target="_blank"} para ver un vídeo de demostración.
