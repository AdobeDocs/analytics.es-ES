...
| `This dimension does not currently support non-default attribution models.` | Se recomienda reemplazar la dimensión de la tabla por una que sea compatible con [Attribution IQ](/help/analyze/analysis-workspace/c-panels/attribution/attribution.md). |
