...
| [!UICONTROL Se ha producido un error inesperado; intente actualizar el proyecto de nuevo. Si el problema persiste, envíe este ID de error al Servicio de atención al cliente de Adobe para que lo diagnostique más.] | Adobe está experimentando un problema que debe resolverse. | Intente actualizar el proyecto y, si el problema persiste, envíe el código de error al Servicio de atención al cliente. |
