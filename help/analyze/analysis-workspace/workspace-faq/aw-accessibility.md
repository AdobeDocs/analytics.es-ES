...
[!UICONTROL Analysis Workspace] ofrece un completo conjunto de [métodos abreviados de teclado (teclas de acceso directo)](/help/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys.md) para lograr un flujo de trabajo más fluido.
