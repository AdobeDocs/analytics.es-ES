...
Tiene la opción de permitir que el intervalo de confianza escale el gráfico. Haga clic en el icono Configuración (engranaje) y marque **[!UICONTROL Allow Anomaly Detection to Scale Y Axis]**.
