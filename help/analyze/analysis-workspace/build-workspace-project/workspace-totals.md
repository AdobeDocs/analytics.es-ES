...
[Los totales de filas](https://docs.adobe.com/content/help/es-ES/analytics/analyze/analysis-workspace/build-workspace-project/column-row-settings/manual-vs-dynamic-rows.translate.html) estáticas se comportan de forma diferente y se controlan en **[!UICONTROL Configuración de fila]**.
