...
| Panel Analytics for Target en Espacio de trabajo  (25 de junio de 2020) | El panel Analytics for Target (A4T) le permite analizar con confianza las actividades y experiencias de Adobe Target en Analysis Workspace. [Más información...](/help/analyze/analysis-workspace/c-panels/a4t-panel.md) |
...
| Función | Descripción |
|--- |--- |
| Compatibilidad con varios grupos de informes en Workspace | Ahora puede incluir datos de varios grupos de informes en un único proyecto de para verlo en paralelo. [Más información...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/multiple-report-suites.html?lang=es) |
...
| Opción para eliminar No especificado/Ninguno | Se ha añadido la opción de quitar fácilmente &#39;No especificado (Ninguno)&#39; a los filtros de informe. |
...
| Mejora | Descripción |
|--- |--- |
| Aumento del límite de elementos para filtros desplegables estáticos de 50 a 200 | El límite de elementos que se pueden colocar en un filtro desplegable estático ha aumentado de 50 a 200. Esta mejora admite una variedad de casos de uso, como agregar todos los países (195) a un filtro, o todos los estados y provincias de EE. UU. (52). |
...
| Mejora | Descripción |
|--- |--- |
| Mejoras de análisis de cohorte | Se han añadido [nuevas configuraciones de análisis de cohorte](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/cohort-table/t-cohort.html?lang=es): <ul><li>Mostrar sólo porcentaje</li><li>Redondear el porcentaje al entero más cercano</li><li>Mostrar una fila porcentual promedia</li></ul> |
...
| Mejora | Descripción |
|--- |--- |
| Se agregó una nueva configuración a la configuración de visualización de flujo: Incluir instancias de repetición. | [Configuración de flujo](/help/analyze/analysis-workspace/visualizations/c-flow/create-flow.md) |
...
| Función | Descripción |
| --- | --- |
| Administración de menús desplegables del panel | Se han realizado algunos cambios en la administración de los menús desplegables del panel. Al hacer clic con el botón derecho en un menú desplegable, ahora puede eliminar el menú desplegable, eliminar una etiqueta (si se muestra alguna) o agregar una etiqueta (si no se muestra ninguna). |
| Vínculos en las descripciones emergentes de visualizaciones y paneles | Se han añadido vínculos a los vídeos y la documentación pertinentes a las informaciones sobre herramientas del panel y de visualización. |
...
<table id="table_137719BFA03C44A78FDE872DF8B228A4">
 ...
 <tbody>
  <tr>
   <td colname="col1"> <p><b>Menús desplegables del panel</b> </p> </td>
...
<table id="table_EE4C690A178B4F80BDAF2BB4424D6020">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p><b>Información adicional sobre  <a href="/help/analyze/analysis-workspace/c-anomaly-detection/view-anomalies.md"  > anomalías </a></b> </p> </td>
...
<table id="table_B9E784CD14A1453EB360FCCDC612250F">
 ...
 <tbody>
  <tr>
   ...
   <td colname="col2"> <p>Ahora, la configuración de columna <span class="uicontrol"> Justificar el texto del encabezado </span> está activada de forma predeterminada en las tablas de forma libre. </p> </td>
  </tr>
  <tr>
  ...
  <tr>
   <td colname="col1"> <p> Disponibilidad exclusiva de <a href="/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md"  > Detección de anomalías y Análisis de contribución</a> en Analysis Workspace </p> </td>
...
<table id="table_580CF2C1322E4FB78870BE2B1F497B2F">
 ...
 <tbody>
  <tr>
   ...
   <td colname="col2"> <p>Ahora puede justificar el texto del encabezado en las tablas de forma libre para que los encabezados sean más legibles y las tablas se puedan compartir con mayor facilidad. Hemos añadido una opción en la configuración de columna llamada “Justificar el texto del encabezado”. Esto resulta muy útil en el procesamiento de archivos .pdf y en las métricas con nombres largos. </p> </td>
  </tr>
  <tr>
   ...
   <td colname="col2"> <p>Con el fin de facilitar la creación rápida de métricas calculadas, se ha añadido la opción <span class="uicontrol"> Crear métrica a partir de selección </span> al menú que se abre al hacer clic con el botón derecho en las tablas de forma libre. Esta opción se muestra cuando se selecciona al menos una celda de columna de encabezado. </p> </td>
  </tr>
  <tr>
...
<table id="table_7A2E678577F94BDABB1276C826E6554F">
 ...
 <tbody>
  <tr>
   <td colname="col1"> <p>Más <a href="/help/analyze/analysis-workspace/visualizations/freeform-table/filter-and-sort.md"  > opciones de filtrado </a> de elementos de dimensión en tablas de forma libre </p> </td>
...
<table id="table_892279F2B4AF4DB38C64AA9AFC5657A7">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/view-anomalies.md"  > Opción para permitir que el intervalo de confianza vuelva a escalar un gráfico </a> </p> </td>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Ahora, en lugar de borrar manualmente cada elemento, se pueden borrar todos en las siguientes áreas de Workspace: </p>
    <ul id="ul_73E06D64CDCA4E83B9FEC2FD99D41CD3">
     <li id="li_A51EF8FADFA04CC19FD79C1675597659"> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/run-contribution-analysis.md"  > Componentes excluidos de Análisis de contribución </a> </li>
...
<table id="table_64E3A9960F314E2F9FFC738696EACDF7">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p><b> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/run-contribution-analysis.md"  > Posibilidad de resaltar una anomalía específica </a></b> </p> </td>
...
<table id="table_5B859A64363A44A98FC55E7AFB3C1D0C">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> Mejoras de <a href="/help/analyze/analysis-workspace/visualizations/c-flow/create-flow.md"  ><b>flujo</b></a> </td>
   <td colname="col2">
...
<table id="table_56258080C60F480AA83E1D5DE7D2C782">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <b> <a href="/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md"  > Detección de anomalías y análisis de contribución </a></b> </td>
...
* La variable  [El panel de comparación de segmentos](/help/analyze/analysis-workspace/c-panels/c-segment-comparison/segment-comparison.md) descubre las diferencias estadísticamente más significativas entre dos segmentos mediante un análisis automatizado de todas y cada una de las métricas y dimensiones a las que tenga acceso.
...
Para transferir proyectos, vaya a **[!UICONTROL Administración]** > **[!UICONTROL Todos los administradores]** > **[!UICONTROL User Management]** > **[!UICONTROL Transferir]**.
