...
Para obtener más información sobre los paneles, consulte [Información general de paneles](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/panels.html?lang=es).
...
Para obtener más información sobre cada uno de estos tipos de componentes, consulte [Resumen de componentes](/help/analyze/analysis-workspace/components/analysis-workspace-components.md).
...
Después de comprender la terminología de los componentes, puede arrastrarlos a las visualizaciones (incluidas las tablas improvisadas) para [cree su análisis](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md).
...
La sincronización de visualizaciones le permite controlar qué tabla de datos o fuente de datos corresponde con una visualización. A continuación se proporciona más información sobre cómo [administración de fuentes de datos](/help/analyze/analysis-workspace/visualizations/t-sync-visualization.md).
...
Puede crear un proyecto en Analysis Workspace como se describe en [Creación de proyectos](/help/analyze/analysis-workspace/build-workspace-project/create-projects.md).
