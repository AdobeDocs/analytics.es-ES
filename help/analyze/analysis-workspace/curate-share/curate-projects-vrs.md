...
>[!Note]
>Los permisos de componentes son el mecanismo principal que controla los componentes que puede ver un usuario. Se administran mediante las Herramientas de administración. La depuración es un filtro secundario.
...
>[!IMPORTANT]
>La depuración de grupos de informes virtuales siempre se aplica antes de la depuración de proyectos, por lo que, incluso aunque en el proyecto depurado se incluyan ciertos componentes, estos se filtrarán si no se incluyen en el grupo de informes virtuales depurado.
