...
* [Métricas calculadas:](/help/components/calculated-metrics/cm-overview.md) usar las métricas y fórmulas como componentes nuevos para utilizarlas en sistemas de informes
