...
| ![Algorítmico](assets/algorithmic.png) | [Algorítmico](algorithmic.md) | Utiliza técnicas estadísticas para determinar dinámicamente la asignación óptima de crédito para la métrica seleccionada. | Útil para evitar conjeturas o heurística al elegir el modelo de atribución adecuado para su negocio. |
...
>[!NOTE] **[!UICONTROL Las ventanas]** retroactivas personalizadas están actualmente en pruebas limitadas. Consulte las versiones [de funciones de](/help/landing/an-releases.md) Adobe Analytics para obtener más información.
