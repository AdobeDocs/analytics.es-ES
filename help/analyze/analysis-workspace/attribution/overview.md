...
* [Comparar modelos](../components/apply-create-metrics.md)de atribución: Ver rápidamente cómo se comparan los distintos modelos de atribución para cualquier métrica.
