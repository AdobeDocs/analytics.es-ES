...
| ¿Qué sucede si deseo ver más de 1 día en la granularidad de nivel de minuto? | Para acceder a los datos con granularidad de nivel de minuto durante un máximo de 1 mes a la vez, puede utilizar las API de Analytics 2.0. Para obtener más información, consulte [Obtención de datos de informes JSON de visores simultáneos con API de Analytics 2.0](https://docs.adobe.com/content/help/en/media-analytics/using/media-reports/media-default-reports/get-concurrent-json20.html). |
