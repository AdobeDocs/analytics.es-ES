...
>[!NOTE] Actualmente, la atribución algorítmica solo está disponible a través de [Adobe Analytics Labs](https://docs.adobe.com/content/help/es-ES/analytics/analyze/tech-previews/overview.html). La función formará parte de una versión general.
