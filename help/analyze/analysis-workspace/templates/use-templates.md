...
>abstract="**Esto puede ayudarte** a comprender mejor cómo las ventas unitarias aumentan o disminuyen con el tiempo. Puede aplicar un segmento para conocer qué clientes o regiones geográficas compran la mayor cantidad de unidades y cómo las ventas de esas unidades son tendencias a lo largo del tiempo.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar la eficacia de una campaña de marketing lanzada recientemente comparando las ventas unitarias antes y después del lanzamiento de la campaña. O puede comparar las ventas unitarias año tras año durante los días festivos.<br/>Esta plantilla usa la dimensión Día y la métrica Unidades."
...
| [!UICONTROL **Página siguiente y anterior**] | Ver los lugares más comunes a los que van las personas inmediatamente después o inmediatamente antes de visitar un lugar determinado. <p>**Esto puede ayudarle** a comprender cómo se mueve el tráfico de una página determinada a otras partes del sitio, así como las rutas que siguen los usuarios para llegar a una página determinada.</p><p>**En función de lo que aprenda, podría** hacer muchas cosas, como evaluar si el diseño de la página podría optimizarse para dirigir a las personas a páginas más deseables, como una página para hacer una compra o dejar una revisión. O evalúe si es probable que la información de la página actual proporciona la dirección o las acciones que las personas buscan a medida que llegan desde páginas anteriores. O puede evaluar si las páginas que no aparecen como páginas anteriores necesitan vínculos más destacados a la página actual.</p><p>Esta plantilla usa el [panel de elemento siguiente o anterior](/help/analyze/analysis-workspace/c-panels/next-previous.md).</p> |
| [!UICONTROL **Campañas (código de seguimiento)**] | Ver los vínculos que generaron más tráfico en su sitio. <p>**Esto puede ayudarle** a comprender mejor qué códigos de seguimiento (y los vínculos con los que están asociados) se utilizaron para obtener acceso al sitio.</p><p>**Según lo que aprenda, podría** hacer muchas cosas, como ajustar su estrategia para agregar vínculos a su sitio.</p><p>Esta plantilla usa la [dimensión de código de seguimiento](/help/components/dimensions/tracking-code.md) y la métrica [Visitas](/help/components/metrics/visits.md).</p> |
...
| [!UICONTROL **Unidades**] | Ver el número total de unidades compradas dentro de todos los pedidos. Los datos se muestran a lo largo de un período de tiempo y se comparan con los períodos anteriores. <p>**Esto puede ayudarte** a comprender mejor cómo las ventas unitarias aumentan o disminuyen con el tiempo. Puede aplicar un segmento para conocer qué clientes o regiones geográficas compran la mayor cantidad de unidades y cómo las ventas de esas unidades son tendencias a lo largo del tiempo.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar la eficacia de una campaña de marketing lanzada recientemente comparando las ventas unitarias antes y después del lanzamiento de la campaña. O puede comparar las ventas unitarias año tras año durante los días festivos.</p><p>Esta plantilla usa la dimensión [Día](/help/components/dimensions/day.md) y la métrica [Unidades](/help/components/metrics/units.md).</p> |
...
>title="Ver el tiempo promedio que los visitantes emplean en el sitio durante cada visita. Los datos se muestran a lo largo de un período de tiempo y se comparan con los períodos anteriores."
>abstract="**Esto puede ayudarte** a comprender mejor los niveles de participación de los visitantes y cuánto tiempo pasan los visitantes en el sitio.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar si los cambios en el sitio hacen que los visitantes pasen más tiempo en el sitio.<br/>Esta plantilla usa la dimensión Día y la métrica Tiempo empleado por visita (segundos)."
...
>title="Ver el tiempo promedio que los usuarios pasan antes de un evento de éxito."
>abstract="**Esto puede ayudarte** a comprender mejor cuánto tiempo tardan los visitantes en realizar una acción deseada, como realizar una compra.<br/>**En función de lo que aprenda, podría** hacer muchas cosas, como evaluar si los cambios en el sitio mejoran la capacidad de los visitantes para llegar rápidamente a un evento de éxito.<br/>Esta plantilla usa la dimensión Tiempo previo al evento y la métrica Visitantes únicos."
...
>title="Ver qué dispositivos utilizaron las personas en todos los puntos del recorrido."
>abstract="**Esto puede ayudarte** a comprender mejor cuántas personas interactúan con tu marca, los tipos de dispositivos que usan y cómo afecta su uso de varios dispositivos a su experiencia. Por ejemplo, ¿con qué frecuencia comienzan una tarea en un dispositivo móvil y luego se trasladan a un escritorio para completarla? ¿Cuáles son las rutas más comunes que los usuarios realizan de un dispositivo a otro? ¿En qué punto abandonan? ¿Dónde tienen éxito? Y así.<br/>**En función de lo que aprenda, podría** hacer muchas cosas, como optimizar ciertas partes del recorrido del usuario para una experiencia móvil.<br/>Esta plantilla usa las métricas Visualización de flujo, Visualización de abandonos, Análisis de cohorte, Personas y Dispositivos únicos."
...
>title="Vea quiénes son los usuarios más fieles y qué están haciendo en el sitio."
>abstract="**Esto puede ayudarle** a comprender mejor la cantidad de veces que la persona promedio visita su sitio, la frecuencia con la que las personas regresan al sitio y la cantidad de días entre las visitas de retorno.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como analizar qué contenido es el más eficaz para llevar a otras personas de vuelta al sitio.<br/>Esta plantilla usa la métrica Visitas y la métrica Visitantes únicos."
...
>abstract="**Esto puede ayudarte** a comprender mejor cómo los visitantes consumen contenido de audio en tu sitio.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como analizar qué contenido se consume más.<br/>Esta plantilla usa la métrica Visitas y la métrica Visitantes únicos."
...
>abstract="**Esto puede ayudarle** a identificar cuándo pueden estar ocurriendo problemas en una página determinada que solicitarían al visitante que vuelva a cargar la página.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar qué páginas tienen problemas que es necesario solucionar.<br/>Esta plantilla usa la métrica Recargas."
...
>title="Ver las páginas principales a las que acceden las personas la primera vez que visitan el sitio durante toda la vida del visitante."
>abstract="**Esto puede ayudarle** a comprender mejor qué páginas dirigen la mayor cantidad de tráfico al sitio o a comprender mejor las primeras impresiones que los visitantes tienen en el sitio.<br/>**Según lo que aprenda, podría** hacer muchas cosas, como optimizar la experiencia inicial que obtienen los usuarios en el sitio o asegurarse de que las páginas que ven los usuarios por primera vez al entrar en el sitio sean acogedoras y proporcionen los vínculos necesarios a otras áreas del sitio.<br/>Esta plantilla usa la métrica Sesiones. También utiliza la visualización de barras y de tabla de forma libre."
...
>title="Ver el número de visitas que consistieron en una sola página única."
>abstract="**Esto puede ayudarte** a comprender mejor los niveles de participación de los visitantes y cuánto tiempo pasan los visitantes en el sitio.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar si los cambios en el sitio hacen que los visitantes pasen más tiempo en el sitio.<br/>Esta plantilla usa la dimensión Visitas de página única."
...
>title="Vea los datos de rendimiento del sitio de Adobe Experience Manager."
>abstract="**Esto puede ayudarte** a comprender mejor la realización de valor de Adobe Experience Manager.<br/>**En función de lo que aprendas, puedes** hacer cualquier cosa, como optimizar la configuración de tu Experience Manager."
...
>title="Vea y analice los efectos de la prevención inteligente del seguimiento (ITP) en la recopilación de datos y la creación de informes."
>abstract="**Esto puede ayudarle** a comprender mejor la posible pérdida de datos debido a las restricciones de cookies impuestas por ITP.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como adaptar la configuración de Analytics para minimizar el impacto de ITP."
...
| [!UICONTROL **Visita en orden previsto**] | Ver dónde salen las personas o dónde continúan a través de una secuencia de páginas predefinidas.<p>**Esto puede ayudarte** a comprender mejor dónde se están saliendo las personas del recorrido del usuario.</p><p>**En función de lo que sepa, podría** hacer cualquier cosa, como analizar las tasas de conversión a través de procesos específicos en el sitio (como un proceso de compra o registro), o analizar las correlaciones entre los eventos del sitio. (Por ejemplo, qué porcentaje de personas que leyeron su política de privacidad fueron a comprar un producto). También puede utilizar esta plantilla para realizar comparaciones paralelas de dos segmentos diferentes en el mismo informe.</p> <p>Esta plantilla usa la [visualización de visitas en el orden previsto](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md).</p> |
| [!UICONTROL **Análisis entre dispositivos**] | Ver qué dispositivos utilizaron las personas en todos los puntos del recorrido.<p>**Esto puede ayudarte** a comprender mejor cuántas personas interactúan con tu marca, los tipos de dispositivos que usan y cómo afecta su uso de varios dispositivos a su experiencia. Por ejemplo, ¿con qué frecuencia comienzan una tarea en un dispositivo móvil y luego se trasladan a un escritorio para completarla? ¿Cuáles son las rutas más comunes que los usuarios realizan de un dispositivo a otro? ¿En qué punto abandonan? ¿Dónde tienen éxito? Y así.</p><p>**En función de lo que aprenda, podría** hacer muchas cosas, como optimizar ciertas partes del recorrido del usuario para una experiencia móvil.</p> <p>Esta plantilla usa [Visualización de flujo](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md), [Visualización de visitas en el orden previsto](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md), [Análisis de cohorte](/help/analyze/analysis-workspace/visualizations/cohort-table/cohort-analysis.md), [la métrica Personas](/help/components/metrics/people.md) y [la métrica Dispositivos únicos](/help/components/metrics/unique-devices.md).</p> |
| [!UICONTROL **Retención web**] | Vea quiénes son los usuarios más fieles y qué están haciendo en el sitio.<p>**Esto puede ayudarle** a comprender mejor la cantidad de veces que la persona promedio visita su sitio, la frecuencia con la que las personas regresan al sitio y la cantidad de días entre las visitas de retorno.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como analizar qué contenido es el más eficaz para llevar a otras personas de vuelta al sitio.<p>Esta plantilla usa las métricas [Visitas](/help/components/metrics/visits.md) y [Visitantes únicos](/help/components/metrics/unique-visitors.md).</p> |
| [!UICONTROL **Consumo de audio multimedia**] | Vea las tendencias y las principales métricas del consumo de audio de medios en todos los dispositivos digitales.<p>**Esto puede ayudarte** a comprender mejor cómo los visitantes consumen contenido de audio en tu sitio.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como analizar qué contenido se consume más.<p>Esta plantilla usa las métricas [Visitas](/help/components/metrics/visits.md) y [Visitantes únicos](/help/components/metrics/unique-visitors.md).</p> |
| [!UICONTROL **Actualización, frecuencia y fidelización de medios**] | Vea las tendencias y las principales métricas de consumo de medios en todos los dispositivos digitales.<p>**Esto puede ayudarle** a comprender mejor la cantidad de veces que la persona promedio visita su sitio, la frecuencia con la que las personas regresan al sitio y la cantidad de días entre las visitas de retorno.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como analizar qué contenido es el más eficaz para llevar a otras personas de vuelta al sitio.<p>Esta plantilla usa las métricas [Visitas](/help/components/metrics/visits.md) y [Visitantes únicos](/help/components/metrics/unique-visitors.md).</p> |
| **[!UICONTROL Análisis de página]** > [!UICONTROL **Resumen de página**] | Ver el tiempo promedio que los visitantes emplean en el sitio durante cada visita. Los datos se muestran a lo largo de un período de tiempo y se comparan con los períodos anteriores. <p>**Esto puede ayudarte** a comprender mejor los niveles de participación de los visitantes y cuánto tiempo pasan los visitantes en el sitio.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar si los cambios en el sitio hacen que los visitantes pasen más tiempo en el sitio.</p><p>Esta plantilla usa la dimensión [Día](/help/components/dimensions/day.md) y la métrica [Tiempo empleado por visita (segundos)](/help/components/metrics/time-spent-per-visit.md).</p> |
| **[!UICONTROL Análisis de página]** > [!UICONTROL **Recargas**] | Ver el número de veces que un elemento de dimensión estuvo presente durante una recarga. La forma más común de activar una recarga es a través de un visitante que actualiza su explorador. <p>**Esto puede ayudarle** a identificar cuándo pueden estar ocurriendo problemas en una página determinada que solicitarían al visitante que vuelva a cargar la página.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar qué páginas tienen problemas que es necesario solucionar.</p><p>Esta plantilla usa la métrica [Recargas](https://experienceleague.adobe.com/en/docs/analytics/components/metrics/reloads).</p> |
| **[!UICONTROL Análisis de página]** > [!UICONTROL **Tiempo empleado en la página**] | Ver el tiempo promedio que los visitantes emplean en el sitio durante cada visita. Los datos se muestran a lo largo de un período de tiempo y se comparan con los períodos anteriores. <p>**Esto puede ayudarte** a comprender mejor los niveles de participación de los visitantes y cuánto tiempo pasan los visitantes en el sitio.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar si los cambios en el sitio hacen que los visitantes pasen más tiempo en el sitio.</p><p>Esta plantilla usa la dimensión [Día](/help/components/dimensions/day.md) y la métrica [Tiempo empleado por visita (segundos)](/help/components/metrics/time-spent-per-visit.md).</p> |
...
| **[!UICONTROL Entradas y salidas]** > [!UICONTROL **Páginas de entrada originales**] | Ver las páginas principales a las que acceden las personas la primera vez que visitan el sitio durante toda la vida del visitante. <p>**Esto puede ayudarle** a comprender mejor qué páginas dirigen la mayor cantidad de tráfico al sitio o a comprender mejor las primeras impresiones que los visitantes tienen en el sitio.</p><p>**Según lo que aprenda, podría** hacer muchas cosas, como optimizar la experiencia inicial que obtienen los usuarios en el sitio o asegurarse de que las páginas que ven los usuarios por primera vez al entrar en el sitio sean acogedoras y proporcionen los vínculos necesarios a otras áreas del sitio.</p><p>Esta plantilla utiliza la métrica Sesiones. También utiliza la visualización de barras y de tabla de forma libre.</p> |
| **[!UICONTROL Entradas y salidas]** > [!UICONTROL **Visitas a una sola página**] | Ver el número de visitas que consistieron en una sola página única. <p>**Esto puede ayudarte** a comprender mejor los niveles de participación de los visitantes y cuánto tiempo pasan los visitantes en el sitio.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar si los cambios en el sitio hacen que los visitantes pasen más tiempo en el sitio.</p><p>Esta plantilla usa la [dimensión de visitas a una sola página](https://experienceleague.adobe.com/en/docs/analytics/components/dimensions/single-page-visits).</p> |
...
| AEM AEM [!UICONTROL ****] > [!UICONTROL **Rendimiento del sitio**] > [!UICONTROL **Rendimiento del sitio de la**] | Vea los datos de rendimiento del sitio de Adobe Experience Manager.  <p>**Esto puede ayudarte** a comprender mejor la realización de valor de Adobe Experience Manager.</p><p>**En función de lo que aprendas, puedes** hacer cualquier cosa, como optimizar la configuración de tu Experience Manager.</p> |
| [!UICONTROL **Impacto de ITP**] | Vea y analice los efectos de la prevención inteligente del seguimiento (ITP) en la recopilación de datos y la creación de informes. <p>**Esto puede ayudarle** a comprender mejor la posible pérdida de datos debido a las restricciones de cookies impuestas por ITP.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como adaptar la configuración de Analytics para minimizar el impacto de ITP.</p> |




Ignorar debajo de esto
...
>title="Vea información creada previamente para los minoristas sobre sus actividades comerciales para mejorar las ventas. Está dirigido a usuarios de Magento, pero puede ser aprovechado por cualquier minorista en línea."
...
| [!UICONTROL **Unidades**] | Ver el número total de unidades compradas dentro de todos los pedidos. Los datos se muestran a lo largo de un período de tiempo y se comparan con los períodos anteriores. <p>**Esto puede ayudarte** a comprender mejor cómo las ventas unitarias aumentan o disminuyen con el tiempo. Puede aplicar un segmento para conocer qué clientes o regiones geográficas compran la mayor cantidad de unidades y cómo las ventas de esas unidades son tendencias a lo largo del tiempo.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como evaluar la eficacia de una campaña de marketing lanzada recientemente comparando las ventas unitarias antes y después del lanzamiento de la campaña. O puede comparar las ventas unitarias año tras año durante los días festivos.</p><p>Esta plantilla usa la dimensión [Día](/help/components/dimensions/day.md) y la métrica [Unidades](/help/components/metrics/units.md).</p> |
| [!UICONTROL **Magento: Marketing y Commerce**] | Vea información creada previamente para los minoristas sobre sus actividades comerciales para mejorar las ventas. Está dirigido a usuarios de Magento, pero puede ser aprovechado por cualquier minorista en línea. <p>**Esto puede ayudarte** a comprender mejor cómo tus actividades comerciales contribuyen a los números de ventas.</p><p>**En función de lo que aprenda, podría** hacer muchas cosas, como ajustar los presupuestos a las actividades que obtienen el máximo retorno de la inversión.</p> |
...
>title="Vea las principales zonas horarias de los visitantes que acceden al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor en qué zonas horarias viven tus visitantes.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como ajustar el mantenimiento del sitio en momentos en que afecte al menor número de personas."
...
>title="Vea los dominios principales de los visitantes que acceden al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor de qué organizaciones provienen tus visitantes.<br/>**En función de lo que sepas, puedes** hacer muchas cosas, como dirigir tu contenido a los clientes más grandes."
...
>title="Ver los anchos de explorador principales que utilizan los visitantes para acceder al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor cómo se muestra el contenido a los visitantes.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio con los anchos de explorador más comunes. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad.<br/>Esta plantilla usa la dimensión Explorador."
...
>title="Ver las alturas superiores del explorador que usan los visitantes para acceder al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor cómo se muestra el contenido a los visitantes.<br/>**Según lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio usando las alturas más comunes del explorador. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad.<br/>Esta plantilla usa la dimensión Explorador. "
...
>abstract="**Esto puede ayudarte** a comprender mejor los sistemas operativos y las versiones más comunes que utilizan los visitantes.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio con los mejores sistemas operativos y versiones. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad."
...
>title="Ver el nombre de los sistemas operativos que usan los usuarios para acceder al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor los sistemas operativos más comunes que usan los visitantes.<br/>**Según lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio con los mejores sistemas operativos. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad."
...
>abstract="**Esto puede ayudarte** a comprender mejor el nivel de participación de los visitantes cuando regresan a tu sitio. Esto se aplica a la duración del visitante, independientemente del intervalo de fechas del proyecto.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como ajustar los esfuerzos de marketing de los visitantes frecuentes.<br/>Esta plantilla usa la dimensión Número de visita."
...
>title="Ver la cantidad de visitantes al sitio que han realizado 0 compras anteriores, 1 compra anterior, 2 compras anteriores o más de 3 compras anteriores."
>abstract="**Esto puede ayudarte** a comprender mejor cómo el sitio afecta el comportamiento de compra. .<br/>**En función de lo que hayas aprendido, puedes** hacer cualquier cosa, como concentrarte en visitantes que regresan para hacer una compra, para que puedas alentar un comportamiento similar para nuevos visitantes.<br/>Esta plantilla usa la dimensión Lealtad del cliente."
...
>title="Permite ver la cantidad de días que transcurren entre la primera vez que un visitante llega al sitio y el momento en el que realiza una compra. Por ejemplo, si un visitante realiza una compra un día después de la primera visita, cualquier visita o evento posterior pertenece al elemento de dimensión de 1 día."
>abstract="**Esto puede ayudarte** a comprender mejor cuánto tiempo tardan los visitantes en realizar una compra.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como actualizar su sitio para acelerar la adquisición.<br/>Esta plantilla usa la dimensión Días antes de la primera compra."
...
>abstract="**Esto puede ayudarte** a comprender mejor el comportamiento de los visitantes después de comprar algo en tu sitio.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como actualizar su sitio para alentar las compras de seguimiento.<br/>Esta plantilla usa la dimensión Días desde la última compra."
...
>title="Vea los tamaños principales de pantalla móvil que usan los visitantes para acceder al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor cómo se muestra el contenido a los visitantes.<br/>**Según lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio usando los tamaños de pantalla móvil más comunes. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad."
...
>title="Ver las alturas de la pantalla del dispositivo móvil que usan los visitantes para acceder al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor cómo se muestra el contenido a los visitantes.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio usando las alturas de pantalla móviles más comunes. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad."
...
>title="Vea los anchos de pantalla móviles principales que los usuarios utilizan para acceder al sitio."
>abstract="**Esto puede ayudarte** a comprender mejor cómo se muestra el contenido a los visitantes.<br/>**Según lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio usando los anchos de pantalla móviles más comunes. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad."
...
| **Perfil del visitante** > **Zonas horarias** | Vea las principales zonas horarias de los visitantes que acceden al sitio. <p>**Esto puede ayudarte** a comprender mejor en qué zonas horarias viven tus visitantes.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como ajustar el mantenimiento del sitio en momentos en que afecte al menor número de personas.</p> |
| **Perfil del visitante** > **Dominios** | Vea los dominios principales de los visitantes que acceden al sitio. <p>**Esto puede ayudarte** a comprender mejor de qué organizaciones provienen tus visitantes.</p><p>**En función de lo que sepas, puedes** hacer muchas cosas, como dirigir tu contenido a los clientes más grandes.</p> |
| **Perfil del visitante** > **Dominios de nivel superior** | Vea los dominios de nivel superior de los visitantes que acceden al sitio. <p>**Esto puede ayudarte** a comprender mejor de qué organizaciones provienen tus visitantes.</p><p>**En función de lo que sepas, puedes** hacer muchas cosas, como dirigir tu contenido a los clientes más grandes.</p> |
| **Perfil del visitante** > **Tecnología** > **Información general sobre tecnología** | <p>**Esto puede ayudarte** a entender mejor</p><p>**Según lo que aprendas, podrías** hacer muchas cosas, como </p><p>Esta plantilla utiliza el </p> |
...
| **Perfil del visitante** > **Tecnología** > **Anchura del explorador** | Ver los anchos de explorador principales que utilizan los visitantes para acceder al sitio.<p>**Esto puede ayudarte** a comprender mejor cómo se muestra el contenido a los visitantes.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio con los anchos de explorador más comunes. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad.</p><p>Esta plantilla utiliza la dimensión Explorador. </p> |
| **Perfil del visitante** > **Tecnología** > **Altura del explorador** | Ver las alturas superiores del explorador que usan los visitantes para acceder al sitio.<p>**Esto puede ayudarte** a comprender mejor cómo se muestra el contenido a los visitantes.</p><p>**Según lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio usando las alturas más comunes del explorador. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad.</p><p>Esta plantilla utiliza la dimensión Explorador. </p> |
| **Perfil del visitante** > **Tecnología** > **Sistema operativo** | Ver el nombre de los sistemas operativos y la versión que usan los usuarios para acceder al sitio.<p>**Esto puede ayudarte** a comprender mejor los sistemas operativos y las versiones más comunes que utilizan los visitantes.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio con los mejores sistemas operativos y versiones. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad.</p> |
| **Perfil del visitante** > **Tecnología** > **Tipos de sistemas operativos** | Ver el nombre de los sistemas operativos que usan los usuarios para acceder al sitio.<p>**Esto puede ayudarte** a comprender mejor los sistemas operativos más comunes que usan los visitantes.</p><p>**Según lo que sepa, podría** hacer muchas cosas, como mejorar la calidad del sitio probando nuevas versiones del sitio con los mejores sistemas operativos. Al hacerlo, se pueden maximizar los esfuerzos de control de calidad.</p> |
...
| **Retención de visitantes** > **Número de visitas** | Ver cuántas veces ha visitado un visitante el sitio.<p>**Esto puede ayudarte** a comprender mejor el nivel de participación de los visitantes cuando regresan a tu sitio. Esto se aplica a la duración del visitante, independientemente del intervalo de fechas del proyecto.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como ajustar los esfuerzos de marketing de los visitantes frecuentes.</p><p>Esta plantilla utiliza la dimensión Número de visita.</p> |
| **Retención de visitantes** > **Ciclo de ventas** > **Lealtad del cliente** | Ver la cantidad de visitantes al sitio que han realizado 0 compras anteriores, 1 compra anterior, 2 compras anteriores o más de 3 compras anteriores. <p>**Esto puede ayudarte** a comprender mejor cómo el sitio afecta el comportamiento de compra. .</p><p>**En función de lo que hayas aprendido, puedes** hacer cualquier cosa, como concentrarte en visitantes que regresan para hacer una compra, para que puedas alentar un comportamiento similar para nuevos visitantes.</p><p>Esta plantilla utiliza la dimensión Lealtad del cliente.</p> |
| **Retención De Visitantes** > **Ciclo De Ventas** > **Días Antes De La Primera Compra** | Permite ver la cantidad de días que transcurren entre la primera vez que un visitante llega al sitio y el momento en el que realiza una compra. Por ejemplo, si un visitante realiza una compra un día después de la primera visita, cualquier visita o evento posterior pertenece al elemento de dimensión “1 día”.<p>**Esto puede ayudarte** a comprender mejor cuánto tiempo tardan los visitantes en realizar una compra.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como actualizar su sitio para acelerar la adquisición.</p><p>Esta plantilla utiliza la dimensión Días antes de la primera compra.</p> |
| **Retención De Visitantes** > **Ciclo De Ventas** > **Días Desde La Última Compra** | Ver la cantidad de tiempo transcurrido entre la visita actual del visitante y su compra más reciente en ese momento.<p>**Esto puede ayudarte** a comprender mejor el comportamiento de los visitantes después de comprar algo en tu sitio.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como actualizar su sitio para alentar las compras de seguimiento.</p><p>Esta plantilla utiliza la dimensión Días desde la última compra.</p> |
| **Móvil** > **Dispositivos Móviles** | Ver la marca y el modelo de dispositivos móviles que los usuarios utilizan para acceder al sitio.<p>**Esto puede ayudarle** a comprender mejor qué dispositivos móviles son los más populares entre su base de usuarios.</p><p>**En función de lo que aprenda, podría** hacer muchas cosas, como optimizar la representación del sitio para los dispositivos móviles más comunes.</p><p>Esta plantilla utiliza la dimensión Nombre del dispositivo móvil.</p> |
| **Móvil** > **Tipo de dispositivo móvil** | Ver los tipos de dispositivos móviles que usan los usuarios para acceder al sitio, como teléfonos y tabletas.<p>**Esto puede ayudarle** a comprender mejor los distintos tipos de dispositivos móviles que se usan para acceder al sitio.</p><p>**En función de lo que aprenda, podría** hacer muchas cosas, como optimizar el sitio para los tipos de dispositivos móviles que más se usan.</p><p>Esta plantilla utiliza la dimensión Tipo de dispositivo móvil.</p> |
...
>title="Vea cómo el sitio web obtiene visitantes en dispositivos móviles."
...
>title="Vea todos los datos de búsqueda pagada de Google y Bing uno al lado del otro."
>abstract="**Esto puede ayudarte** a comprender mejor la cantidad de tráfico que se envía a tu sitio y si los clientes están realizando la conversión.<br/>**En función de lo que sepa, podría** hacer muchas cosas, como estimar la rentabilidad de una campaña publicitaria."
...
>title="Ver en qué página de resultados de búsqueda hizo clic un visitante en el sitio. Por ejemplo, si su sitio aparece en la segunda página de los resultados de búsqueda de un motor de búsqueda, el elemento de dimensión para esta variable es Página de búsqueda 2."
>abstract="**Esto puede ayudarte** a comprender mejor la clasificación de tus páginas en los resultados de búsqueda.<br/>**En función de lo que aprendas, puedes** hacer cualquier cosa, mejorar tu estrategia de SEO para asegurarte de que el contenido se muestre en la primera página de resultados de búsqueda."
...
| [!UICONTROL **Campañas**] > [!UICONTROL **Canal de conversión de campañas**] | <p>**Esto puede ayudarte** a entender mejor</p><p>**Según lo que aprendas, podrías** hacer muchas cosas, como </p><p>Esta plantilla utiliza el  </p> |
...
| **Advertising Analytics: búsqueda de pago** | Vea todos los datos de búsqueda pagada de Google y Bing uno al lado del otro. <p>**Esto puede ayudarte** a comprender mejor la cantidad de tráfico que se envía a tu sitio y si los clientes están realizando la conversión.</p><p>**En función de lo que sepa, podría** hacer muchas cosas, como estimar la rentabilidad de una campaña publicitaria.</p> |
| **Buscar palabras clave-todas** | Ver las palabras clave de búsqueda que los visitantes utilizan para llegar al sitio, independientemente de si son de pago o no. <p>**Esto puede ayudarle** a comprender mejor las palabras clave que usan los visitantes en las búsquedas que generan el tráfico del sitio. </p><p>**En función de lo que aprenda, podría** hacer cualquier cosa, como identificar y rellenar los huecos de SEO entre las palabras clave que se están usando y las que están impulsando el tráfico del sitio.</p><p>Esta plantilla utiliza la dimensión Buscar palabra clave. </p> |
...
| **Clasificación de todas las páginas de búsqueda** | Ver en qué página de resultados de búsqueda hizo clic un visitante en el sitio. Por ejemplo, si su sitio aparece en la segunda página de los resultados de búsqueda de un motor de búsqueda, el elemento de dimensión para esta variable es “Página de búsqueda 2”.<p>**Esto puede ayudarte** a comprender mejor la clasificación de tus páginas en los resultados de búsqueda.</p><p>**En función de lo que aprendas, puedes** hacer cualquier cosa, mejorar tu estrategia de SEO para asegurarte de que el contenido se muestre en la primera página de resultados de búsqueda. </p> |
