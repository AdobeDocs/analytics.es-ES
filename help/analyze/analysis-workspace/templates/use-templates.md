...
1. En Adobe Analytics, seleccione las pestañas [!UICONTROL **Workspace**] y [!UICONTROL **Plantillas**].
...
>title="Ver el número de veces que un elemento de dimensión estuvo presente durante una recarga. Un visitante que actualiza su explorador es la forma más común de activar una recarga."
