...
seo-title: Código de implementación de muestra
solution: Analytics
title: Código de implementación de muestra
topic: Activity Map
...
Observe que las secciones de código que nos interesan en esta implementación de Activity Map están en **negrita**.
