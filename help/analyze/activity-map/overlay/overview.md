...
En la parte superior, puede ver la página web con la barra de herramientas insertada y las superposiciones de vínculos. Sobre los vínculos se muestran clasificaciones de burbujas que indican el número total de clics.
...
En la parte inferior de la página, puede ver los informes Vínculos en la página y Detalles de página, que permiten ver un resumen de las estadísticas actuales de la página web, así como la información del flujo de página.
