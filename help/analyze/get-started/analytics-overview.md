---
description: Información general sobre Adobe Analytics
...
* [Segmentación avanzada](/https://experienceleague.adobe.com/docs/analytics/components/segmentation/seg-home.html)
...
El [!UICONTROL Workspace] La pestaña muestra una lista de proyectos de Analysis Workspace.
...
2. Seleccione cualquiera de las siguientes funciones de producto para configurarlo:
   ...
   | Search&amp;Promote |  |  |
   | Mobile Services |  |  |
   | Paneles de Analytics (aplicación móvil) |  |  |
   | Report Builder |  |  |
...
## Introducción para administradores, analistas y usuarios finales
...
Una vez implementado Adobe Analytics, los administradores deben realizar varias tareas de configuración para garantizar que los analistas y los usuarios finales obtengan todo el valor de Adobe Analytics.
...
| Detección de anomalías y análisis de contribución | | |
