...
Para obtener más información acerca de las características y funciones disponibles en la pestaña [!UICONTROL Espacio de trabajo], consulte la [Página de destino de Adobe Analytics](/help/analyze/landing.md).

## Pestaña de informes

En su lugar, utilice el área [!UICONTROL **Informes**] del carril izquierdo de la pestaña [!UICONTROL **Espacio de trabajo**]. Para obtener más información, consulte *Navegar por la pestaña Informes* en la [Página de destino de Adobe Analytics](/help/analyze/landing.md).
...
1. En Adobe Analytics, seleccione la pestaña [!UICONTROL **Componentes**] y, a continuación, seleccione [!UICONTROL **Todos los componentes**].
   ...
   ![Pestaña Espacio de trabajo](assets/components-tab.png)
...
2. Seleccione cualquiera de las siguientes características de producto para proceder a su configuración:
   ...
   | Anotaciones | Las anotaciones en Workspace le permiten comunicar de forma eficaz los matices y perspectivas de datos contextuales a su organización. Permiten enlazar los eventos de calendario con dimensiones y métricas específicas. | [Administración de anotaciones](/help/analyze/analysis-workspace/components/annotations/manage-annotations.md) |
   | Conjuntos de clasificación | Los conjuntos de clasificación proporcionan una interfaz única para administrar las clasificaciones y las reglas. <p>Las clasificaciones permiten aplicar categorías a los datos de variables de Analytics para mostrarlos de distintos modos cuando se generan los informes. Establece una relación entre un valor variable y los metadatos relacionados con ese valor. Las clasificaciones se pueden utilizar en la mayoría de las dimensiones personalizadas, como código de seguimiento, props y eVars.</p> | [Información general sobre los conjuntos de clasificación](/help/components/classifications/sets/overview.md) |
   | Ubicaciones | Para importar datos de clasificación de Adobe Analytics desde un destino en la nube, primero debe añadir y configurar la ubicación en la que desea que se recopilen los datos de clasificación. Puede crear, editar o eliminar ubicaciones. | [Administrador de ubicaciones](/help/components/locations/locations-manager.md) |
   ...
   | Informes programados | Con el nivel de administrador se puede ver y gestionar los informes programados de toda la organización. | [Cola de informes programados](/help/components/scheduled-reports-admin.md) |
...
2. Seleccione cualquiera de las siguientes características de producto para proceder a su configuración:
   ...
   | Inicio de User Management (heredado) | La administración de usuarios y productos se ha trasladado a Adobe Admin Console. Utilice Adobe Admin Console para empezar a administrar los permisos de usuario de Adobe Analytics. | [Analytics en Adobe Admin Console](/help/admin/admin-console/home.md) |
   | Grupos (heredados) | La administración de grupos se ha trasladado a Adobe Admin Console. Utilice Adobe Admin Console para empezar a administrar grupos para Adobe Analytics. | [Analytics en Adobe Admin Console](/help/admin/admin-console/home.md) |
   | Acceso al grupo de informes | El método para conceder acceso a las herramientas del grupo de informes se ha trasladado a Adobe Admin Console. Utilice Adobe Admin Console para conceder acceso al grupo de informes en Adobe Analytics. | [Permisos de perfil de productos para las herramientas de grupo de informes](/help/admin/admin-console/permissions/report-suite-tools.md) |
   ...
   | Grupos de informes | Le permite definir las reglas que rigen el modo en que se procesan los datos en un grupo de informes. | [Administrador del grupo de informes](/help/admin/tools/manage-rs/report-suites-admin.md) |
   | Usuarios y recursos de Analytics | La administración de usuarios y recursos se ha trasladado a Adobe Admin Console. Utilice Adobe Admin Console para empezar a administrar los permisos de usuario de Adobe Analytics. | [Analytics en Adobe Admin Console](/help/admin/admin-console/home.md) |
   | Importador de clasificaciones | Utilice el importador para cargar clasificaciones en Adobe Analytics. También puede exportar los datos para actualizarlos antes de importarlos. | [Resumen del importador de clasificaciones](/help/components/classifications/importer/c-working-with-saint.md) |
   | Generador de reglas de clasificación | En lugar de mantener y cargar clasificaciones cada vez que cambien sus códigos de seguimiento, puede crear clasificaciones automáticas basadas en reglas y aplicarlas en varios grupos de informes. | [Flujo de trabajo del generador de reglas de clasificación](/help/components/classifications/crb/classification-rule-builder.md) |
   ...
   | Etiquetado de privacidad de gobernanza de datos | Al etiquetar los datos de los grupos de informes, se asignan etiquetas de identidad, confidencialidad y gobernanza de datos a cada variable de un grupo de informes determinado. | [Etiquetado de privacidad](/help/admin/tools/privacy-labeling/labeling-overview.md) |
   | Inicio de configuración de la compañía | La página Configuración de la empresa permite configurar opciones que se aplican a todos los grupos de informes que gestiona la organización. | [Información general de configuración de la compañía](/help/admin/tools/company/c-company-settings.md) |
