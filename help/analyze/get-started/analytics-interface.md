...
2. Seleccione cualquiera de las siguientes funciones de producto para configurarlo:
   ...
   | Search&amp;Promote | Esta función ya no es compatible. |  |
   | Mobile Services | Esta función ya no es compatible. |  |
