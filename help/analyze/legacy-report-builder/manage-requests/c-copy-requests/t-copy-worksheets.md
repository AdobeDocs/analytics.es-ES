---
description: Aprenda a copiar una hoja de cálculo en otra hoja del mismo libro.
title: Cómo copiar hojas de cálculo en Report Builder
...
1. Haga clic de nuevo con el botón derecho y seleccione **[!UICONTROL Pegar hoja de cálculo con solicitudes]**.
   ...
   Se agrega una nueva hoja de cálculo al libro. De forma predeterminada, la hoja de cálculo tiene el mismo nombre que la hoja de cálculo original, pero tiene el sufijo (2). Si repite la operación de pegado, la nueva hoja de cálculo tendrá el sufijo (3), etc. Al pegar una hoja de cálculo que ha copiado, la nueva hoja de cálculo se encuentra a la derecha (inmediatamente después) de la hoja de cálculo activa.
