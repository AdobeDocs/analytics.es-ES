---
description: Puede especificar un intervalo de fechas seleccionando celdas de una hoja de cálculo que contenga una solicitud. Report Builder utiliza la información del intervalo de fechas concretas en esas solicitudes. Si selecciona la fecha de hoy, verá datos parciales basados en la hora del día en que se ejecuta la solicitud.
...
Puede especificar un intervalo de fechas seleccionando celdas de una hoja de cálculo que contenga una solicitud. Report Builder utiliza la información del intervalo de fechas concretas en esas solicitudes. Si selecciona la fecha de hoy, verá datos parciales basados en la hora del día en que se ejecuta la solicitud.

**Para configurar fechas desde una celda**
