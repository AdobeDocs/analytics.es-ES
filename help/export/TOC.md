...
+ Fuente de datos de Analytics {#analytics-data-feed}
   ...
   + Contenido de la fuente de datos {#data-feed-contents}
      ...
      + [Recursos de encabezado](analytics-data-feed/c-df-contents/headers.md)
...
+ [Descargas de Analysis Workspace](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/curate-share/download-send.html)
