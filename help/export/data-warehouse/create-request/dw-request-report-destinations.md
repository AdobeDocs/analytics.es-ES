...
1. (Condicional) Si no tiene acceso a una cuenta en la nube que ya esté configurada en Adobe Analytics, puede configurar una:
   ...
   1. Seleccione el menú desplegable [!UICONTROL **Cuenta**] y luego seleccione [!UICONTROL **Añadir cuenta**].

   1. En el cuadro de diálogo Añadir cuenta, especifique la siguiente información:
