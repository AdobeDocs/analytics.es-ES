...
1. (Opcional) Seleccione el icono **Filtrar** ![del diccionario de datos](/help/analyze/analysis-workspace/components/data-dictionary/assets/data-dictionary-filter-icon.png) y, a continuación, cualquiera de las siguientes opciones para filtrar la lista de componentes:
   ...
   | [!UICONTROL **Mostrar duplicados**] | Mostrar solo los componentes que tengan la misma etiqueta o descripción que la de otro componente en el grupo de informes seleccionado. Esto incluye tanto los componentes que crea como los que proporciona Adobe. Las etiquetas o descripciones deben coincidir de forma exacta para que se muestren como duplicados. Esta opción solo está disponible para administradores. |
