...
+ [](home.md)
+ 
+ [Cuentas y grupos de informes](landing.md)
+ Personalizar vistas de informes{#analysis-workspace}
   + [Informes de Google Analytics {#reports}](analysis-workspace/home.md)
   + [Crear un informe básico en Analysis Workspace para usuarios de GA](analysis-workspace/new-features-in-analysis-workspace.md)
   + Métricas comunes utilizadas en otras plataformas de Analytics{#build-workspace-project}
      + [Tiempo real](analysis-workspace/build-workspace-project/freeform-overview.md)
      + [Audiencia](analysis-workspace/build-workspace-project/save-projects.md)
      + [Adquisición](analysis-workspace/build-workspace-project/starter-projects.md)
      + [Comportamiento](analysis-workspace/build-workspace-project/multiple-report-suites.md)
      + [Conversiones](analysis-workspace/build-workspace-project/fa-shortcut-keys.md)
      + [Preguntas frecuentes](analysis-workspace/build-workspace-project/color-palettes.md)
      + [Procesamiento de diferencias entre plataformas](analysis-workspace/build-workspace-project/view-density.md)
   + Comparación de datos con productos de terceros{#components}
      + [Analizar datos afectados por eventos {#event}](analysis-workspace/components/analysis-workspace-components.md)
      + Información general sobre el análisis de datos afectados por eventos{#annotations}
         + [Solución de problemas de picos y caídas de datos](analysis-workspace/components/annotations/overview.md)
         + [Excluir fechas específicas en el análisis](analysis-workspace/components/annotations/create-annotations.md)
         + [Comparar fechas con intervalos anteriores](analysis-workspace/components/annotations/manage-annotations.md)
         + [Derivar datos afectados por eventos](analysis-workspace/components/annotations/view-annotations.md)
      + Comunicar eventos a los usuarios{#dimensions}
         + [Suavizado de datos inteligente](analysis-workspace/components/dimensions/view-dimensions.md)
         + [Cookies {#cookies}](analysis-workspace/components/dimensions/t-breakdown-fa.md)
         + [Cookies del explorador](analysis-workspace/components/dimensions/time-parting-dimensions.md)
      + [Opciones para mitigar el efecto de las limitaciones de cookies del explorador](analysis-workspace/components/apply-create-metrics.md)
      + Retención de datos{#segments}
         + [Excluir datos](analysis-workspace/components/segments/t-freeform-project-segment.md)
         + [IP y dominios utilizados por Adobe Analytics](analysis-workspace/components/segments/quick-segments.md)
         + [Latencia](analysis-workspace/components/segments/ad-hoc-segments.md)
      + Valor de poco tráfico{#calendar-date-ranges}
         + [Migración de las reglas de procesamiento de Mobile Services a Adobe Analytics](analysis-workspace/components/calendar-date-ranges/calendar.md)
         + [Compatibilidad con múltiples monedas](analysis-workspace/components/calendar-date-ranges/custom-date-ranges.md)
         + [Resumen de privacidad](analysis-workspace/components/calendar-date-ranges/time-comparison.md)
   + Aplicaciones web progresivas{#visualizations}
      + [Redirecciones y alias](analysis-workspace/visualizations/freeform-analysis-visualizations.md)
      + [Recopilación de datos regionales {#rdc}](analysis-workspace/visualizations/t-sync-visualization.md)
      + Ayuda de recopilación de datos regionales{#freeform-table}
         + [Licencias de certificación SSL](analysis-workspace/visualizations/freeform-table/freeform-table.md)
         + Algoritmos de cifrado HTTPS admitidos{#column-row-settings}
            + [Recursos de seguridad](analysis-workspace/visualizations/freeform-table/column-row-settings/column-settings.md)
            + [Términos utilizados (glosario)](analysis-workspace/visualizations/freeform-table/column-row-settings/table-settings.md)
            + [Marcas de hora opcionales](analysis-workspace/visualizations/freeform-table/column-row-settings/manual-vs-dynamic-rows.md)
         + [Solución de problemas de inicio de sesión](analysis-workspace/visualizations/freeform-table/pagination-filtering-sorting.md)
         + [Solución de problemas de cierre de sesión](analysis-workspace/visualizations/freeform-table/workspace-totals.md)
      + No especificado, otros y desconocido{#cohort-table}
         + [Migración de visitantes](analysis-workspace/visualizations/cohort-table/cohort-analysis.md)
