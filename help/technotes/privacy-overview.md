...
Adobe mantiene tres ubicaciones de procesamiento de datos para Adobe Analytics. Estos sitios reciben datos sin procesar y los procesan en un grupo de informes, que está optimizado para el almacenamiento de datos y la recuperación de informes. Estas ubicaciones de procesamiento de datos residen en Estados Unidos (Oregón), Reino Unido (Londres) y Singapur. Consulte [Información general sobre seguridad de Adobe Analytics](https://www.adobe.com/content/dam/cc/en/trust-center/ungated/whitepapers/experience-cloud/adb-analytics-security-wp.pdf){target=_blank} para obtener más información.
