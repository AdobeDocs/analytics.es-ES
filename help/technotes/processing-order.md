...
6. [**Reglas de procesamiento de canal de marketing**](/help/admin/tools/manage-rs/edit-settings/marketing-channels/mc-proc-rules.md): puede usar [Reglas de procesamiento](/help/admin/tools/manage-rs/edit-settings/general/processing-rules/pr-overview.md) para preparar los datos y usarlos en las reglas de procesamiento del canal de marketing.
