...
Este informe muestra los datos de rendimiento de visitas, costes e ingresos de los canales de marketing de pago. Adobe Advertising, un producto independiente, proporciona esta funcionalidad. Si su organización está interesada en utilizar este producto, póngase en contacto con el equipo de cuenta de Adobe.
