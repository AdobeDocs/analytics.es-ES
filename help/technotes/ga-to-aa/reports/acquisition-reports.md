...
En Adobe Analytics, estos informes se conocen como Canales **de marketing**. Requieren una configuración inicial básica, pero permiten una vista de los canales mucho más personalizada.
...
1. Haga clic en el icono Visualizaciones de la izquierda y arrastre la visualización de rectángulos al espacio de trabajo sobre la tabla improvisada vacía.
...
4. Tenga en cuenta que las métricas adicionales crean mapas de árbol adicionales. Si solo se desea una coincidencia:
   ...
   2. Pulse Mayús y haga clic en la última celda de la misma columna de métrica para resaltar la columna azul. Si se realiza correctamente, en la visualización hay un mapa de rectángulo.
...
A veces, los visitantes llegan al sitio a través de múltiples canales en la misma sesión. Por ejemplo: un visitante hace clic en una página de medios sociales y luego, unos minutos después, visita un motor de búsqueda para llegar a su sitio. En estos casos, los dominios no sociales pueden aparecer en este informe. Si desea excluir los dominios no sociales, ordene el informe por visitas o cree una copia del segmento que se base en las visitas en lugar de en las visitas. Consulte Contenedores [de segmentación](/help/components/c-segmentation/seg-overview.md) en la guía del usuario Componentes para obtener más información.

### Social: referencias de red

El informe Referencias de red muestra qué dominios de redes sociales conducen el tráfico al sitio. Estos datos están disponibles en Analysis Workspace mediante la dimensión Dominio **de** referencia y el segmento **Visitas desde sitios** sociales.
