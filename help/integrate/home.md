...
Esta guía se centra en la integración de varias soluciones empresariales de Adobe CX, como Audience Manager, Advertising o Target. Incluye:
...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Analytics para Advertising](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/integrations/ad-cloud/introduction-to-the-analytics-for-advertising-cloud-dsp-integration){target="_blank"} para ver un vídeo de demostración.
