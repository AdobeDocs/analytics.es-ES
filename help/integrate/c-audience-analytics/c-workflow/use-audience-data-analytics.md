...
1. En la lista de **[!UICONTROL Dimensions]**, seleccione las dimensiones **[!UICONTROL Audience ID]** o **[!UICONTROL Audience Name]**. Nombre es una clasificación descriptiva del ID.
...
1. Busque [!UICONTROL Audiences Name] en el **[!UICONTROL Component]** menú.
...
1. Haga clic en **[!UICONTROL Build]**.
1. (Opcional): Arrastre cualquier otra dimensión a la visualización Flujo para crear un [Flujo entre dimensiones](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/flow/multi-dimensional-flow.html).
...
Las [visualizaciones de Venn](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/venn.html) muestran el solapamiento entre un máximo de 3 segmentos.

1. Go to **[!UICONTROL Workspace]** and select the **[!UICONTROL Venn]** visualization from the left rail.

1. Busque [!UICONTROL Audience Name] en el menú de componentes.
...
1. Vaya a  **[!UICONTROL Components]** > **[!UICONTROL Segments]** .
...
1. Para realizar la vista del informe de Analytics, vaya a **[!UICONTROL Reports]** > **[!UICONTROL Visitor Profile]** > **[!UICONTROL Audience ID Reports]** .
