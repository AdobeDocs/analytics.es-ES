...
Los clientes actuales de la solución Adobe Analytics no tienen ningún costo adicional asociado con el uso de esta integración de Conectores de datos. Los clientes que todavía no pasen al nuevo producto de Adobe Analytics deben ponerse en contacto con su representante de cuentas de Adobe para obtener más detalles.

## ~Consideraciones~ sobre los precios del socio {#section-f8ca71df32224412a5101efb6e356529}

This integration is available to [!DNL ~Partner~] customers, however additional integration fees will apply. Póngase en contacto con sales@optivo.com para obtener detalles sobre precios. Please contact [!DNL ~Partner~] for pricing details.
