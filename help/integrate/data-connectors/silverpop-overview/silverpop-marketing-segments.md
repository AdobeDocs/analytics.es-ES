...
* **Perfil de abandono de formulario (opcional):** Anime a los visitantes a completar un formulario sin terminar a través de campañas diseñadas específicamente para aquellos que comenzaron y no completaron un formulario en línea. Este segmento solo se creará si se crean 2 eventos para inicios de formulario y finalizaciones de formulario.
* **Perfil de descarga de archivos (opcional):** Llegue a posibles clientes a través de campañas diseñadas para aquellos que hayan mostrado interés descargando un documento técnico u otro tipo de descarga. Este segmento solo se creará si se crea un evento para descargas de archivos exitosas.
