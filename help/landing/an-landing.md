...
* Cambios principales en el menú de Analytics: El menú superior **[!UICONTROL Informes]** ya no está ahí. La mayoría de los informes se encuentran ahora en el menú [!UICONTROL Informes], en el carril izquierdo.
...
| Mostrar menos/más | Alterna entre no mostrar y mostrar el banner: ![](assets/top-banner.png) |
...
| Icono de anclaje | **Nuevo** Ahora puede fijar elementos para que *siempre* aparezcan en la parte superior de la lista. |
