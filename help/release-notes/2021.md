...
Para obtener las últimas actualizaciones de las versiones de AppMeasurement (2.22.1), consulte las [notas de la versión de AppMeasurement para JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=en).

## Julio de 2021 {#jul2021}

| Función | Descripción | [Disponibilidad general](releases.md) - Fecha de destino |
| ----------- | ---------- | ------- |
| Nueva página de aterrizaje de Adobe Analytics (Abrir Beta) | La nueva página de aterrizaje de Adobe Analytics reúne tanto Analysis Workspace como Reports &amp; Analytics en una sola interfaz y punto de acceso bajo el paraguas de Workspace. Incluye una nueva página de inicio del administrador de proyectos, un menú de informes actualizados y modernizados, así como una nueva sección de aprendizaje que le ayudará a iniciarse de forma más eficaz. La nueva página mejora la capacidad de detección y guía a los usuarios de Reports &amp; Analytics para mejorar la experiencia de creación de informes en Workspace. [Más información](https://experienceleague.adobe.com/docs/analytics.html?lang=es) | 26 de julio de 2021 |
