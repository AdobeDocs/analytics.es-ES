...
| **Período de retención del ID de transacción** | El período de retención del ID de transacción de 90 días se ampliará a 25 meses en enero de 2025. La variable `transactionID` identifica de forma exclusiva una transacción para que la visita se pueda enlazar a los datos cargados a través de las fuentes de datos. |  | jueves, 22 de enero de 2025 |
