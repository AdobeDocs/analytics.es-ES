...
# Notas de la versión actuales de Adobe Analytics (junio de 2022)
...
| ----------- | ---------- | ---------- |
| **Nuevo dominio para correos electrónicos generados por el sistema** | 13 de julio de 2022 | Adobe ha cambiado recientemente el dominio del remitente para correos electrónicos de proyectos de Workspace, alertas y alertas de sobrecarga, de `noreply@omniture.com` a `noreply@adobe.com`. Añada este nuevo correo electrónico a la lista de permitidos si su organización solo permite remitentes específicos. |
