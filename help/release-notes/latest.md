...
| ----------- | ---------- | ------- | ---- |
| **Compatibilidad con destinos seguros en el nuevo Report Builder** | Se han añadido nuevos destinos de exportación al complemento Report Builder. Se admiten los siguientes destinos de almacenamiento en la nube: <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> Ya no se admite FTP por motivos de seguridad. (Vínculo a la documentación a continuación) |  | 19 de junio de 2025 (originalmente el 18 de junio) |
