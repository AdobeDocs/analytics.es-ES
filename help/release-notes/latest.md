...
| **Navegación actualizada a la interfaz de usuario de Atributos del cliente** | Ahora se puede acceder a la interfaz de usuario de Atributos del cliente directamente desde el selector de aplicaciones de Adobe Experience Cloud. Seleccione **[!UICONTROL Atributos del cliente]** en el menú desplegable (en lugar de ir a [!UICONTROL Personas] > [!UICONTROL Atributos del cliente]) y actualice sus marcadores.  La actualización incluye algunas mejoras en la IU. | 1 de julio de 2025 | 31 de julio de 2025 |
