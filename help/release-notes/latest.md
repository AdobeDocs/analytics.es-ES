...
# Notas de la versión actuales de Adobe Analytics (versión de agosto de 2025)
...
* [Notas de la versión de Streaming Media Services](https://experienceleague.adobe.com/docs/media-analytics/using/additional-resources/release-notes.html?lang=es)
