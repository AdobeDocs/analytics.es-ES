...
| ----------- | ---------- | ---- |
| **Mejoras de Activity Map**<br/> Activity Map incluye las siguientes mejoras:</p><ul><li>Compatibilidad con la extensión Activity Map Overlay con implementaciones Web SDK de Adobe Analytics.</li><li>Compatibilidad con el seguimiento del SDK web (cuando el seguimiento se dirige a Analytics).</li><li>Estilo actualizado en toda la interfaz de usuario.</li></ul><p>(Vínculo a la documentación a continuación).</p> | | Abril de 2026 |
