...
| **Establecer `contextData` Campos de mediante XDM** | Los clientes que envían datos a Adobe Analytics a través del Experience Edge Network pueden [establecer valores de datos de contexto](https://experienceleague.adobe.com/en/docs/analytics/implementation/vars/page-vars/contextdata) directamente en XDM o en las partes de &quot;datos&quot; de la carga útil. |  | Disponible ahora |
...
* Se han corregido los siguientes problemas de Data Warehouse: AN-346789; AN-347031; AN-347568;
