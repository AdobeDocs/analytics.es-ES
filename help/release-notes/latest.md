...
| **Compatibilidad con destinos seguros en la nube en el nuevo Report Builder** | El complemento Report Builder de JavaScript ahora admite la exportación de informes a los siguientes destinos de almacenamiento en la nube:<ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul><p>Anteriormente, solo estaban disponibles los destinos de FTP y correo electrónico. Ya no se admite FTP por motivos de seguridad.</p><p>Para obtener más información, consulte [Programar libros de trabajo exportándolos a destinos en la nube](/help/analyze/report-builder/report-builder-export.md).</p><p>Además de estos cambios, al crear una ubicación en Adobe Analytics, el campo Usar con ahora ofrece la posibilidad de usar la ubicación con Report Builder, tal como se describe en [Configurar ubicaciones de importación y exportación en la nube](/help/components/locations/configure-import-locations.md).</p> |  | 19 de junio de 2025 (originalmente, el 18 de junio) |
