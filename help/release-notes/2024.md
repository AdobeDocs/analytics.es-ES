...
| Función | Descripción | [Inicio del despliegue](releases.md) | [Disponibilidad general](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Recopilación de medios de streaming: envía datos de Roku al Edge Network de Adobe Experience Platform** | Ahora, al [instalar la recopilación de medios de streaming con Experience Platform Edge](https://experienceleague.adobe.com/es/docs/media-analytics/using/implementation/edge-recommended/media-edge-sdk/implementation-edge), puedes usar Adobe Experience Platform Roku SDK para enviar datos de medios de streaming a Adobe Experience Platform. |  | 12 de abril de 2024 |
