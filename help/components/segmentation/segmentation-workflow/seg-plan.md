...
1. Determine el **alcance** del segmento. ¿Qué [contenedor de segmento](/help/components/segmentation/seg-overview.md) representa mejor el ámbito? Utilice el contenedor más pequeño posible.

1. Decida qué **elementos** y qué valores incluirá en la definición del segmento. Considere la [persistencia de la variable](/help/components/segmentation/seg-overview.md) en esta decisión.
