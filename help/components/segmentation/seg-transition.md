...
+++ **Qué les ha sucedido a los segmentos de CX Enterprise (Suite):**
...
+++ **¿Qué debo hacer con los segmentos duplicados que tienen el mismo nombre pero que pueden tener definiciones diferentes?** 
Ahora que los segmentos funcionan en múltiples grupos de informes, es posible que descubra que tiene múltiples segmentos con el mismo nombre. Debe hacer lo siguiente:
