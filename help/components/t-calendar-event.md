...
seo-description: Pasos para añadir eventos de calendario y gestionar eventos compartidos.
seo-title: Eventos de calendario
solution: Analytics
...
1. Under **[!UICONTROL Shared Calendar Events]**, specify one of these options:
       ...
       | ** Cópieme** | Agrega una copia a la lista de eventos utilizando el mismo nombre que el original. Sin embargo, no puede ver ninguna actualización/cambio realizado por el propietario del evento. |
       |---|---|
