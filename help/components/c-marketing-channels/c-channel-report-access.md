...
Estos son los permisos de las Herramientas de grupos de informes necesarios en [Admin Console](https://adminconsole.adobe.com/es) para poder trabajar con varios aspectos de los canales de marketing.
...
Para obtener más información sobre los perfiles de producto y los permisos de Adobe Analytics en Admin Console, consulte [Perfiles de producto para Adobe Analytics](/help/admin/admin-console/permissions/product-profile.md).
