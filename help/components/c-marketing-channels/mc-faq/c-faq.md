...
1. **[!UICONTROL Referrer]** y **[!UICONTROL Does Not Exist]** y **[!UICONTROL Is First Page of Visit]**. (Consulte [Directas.](/help/components/c-marketing-channels/mc-faq/c-faq.md))

2. **[!UICONTROL Referrer Matches Internal URL Filters]** y **[!UICONTROL Is First page of Visit]**. (Consulte [Internas](/help/components/c-marketing-channels/mc-faq/c-faq.md).)

3. **[!UICONTROL Referrer]** y **[!UICONTROL Exists]** y **[!UICONTROL Referrer Does Not Match Internal URL Filters]**.

Por último, cree el canal *Otros* para que capture las visitas restantes, tal como se describe en [No se ha identificado el canal](/help/components/c-marketing-channels/mc-faq/c-faq.md#no-channel-identified).
