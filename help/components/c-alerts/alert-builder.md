...
Para obtener información más detallada sobre las alertas, consulte [Resumen de alertas](intellligent-alerts.md).

Para crear una alerta:

1. Utilice cualquiera de las siguientes formas de crear una alerta:

   * Abra un proyecto en Analysis Workspace y seleccione **[!UICONTROL Componentes]** > **[!UICONTROL Crear alerta]**.
   * Abra un proyecto en Analysis Workspace y, a continuación, utilice el acceso directo siguiente: ***cmd + mayús + a*** (macOS) o ***ctrl + mayús + a*** (Windows).
   * Abra un proyecto en Analysis Workspace, seleccione uno o más elementos de línea en una tabla de forma libre, haga clic con el botón derecho y seleccione **[!UICONTROL Crear alerta a partir de la selección]**. Esta acción rellena instantáneamente el [generador de alertas](alert-builder.md) para crear una alerta con las métricas y los filtros correctos.
