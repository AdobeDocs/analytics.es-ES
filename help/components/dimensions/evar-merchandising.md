...
*Esta página de ayuda describe cómo funcionan las eVars de comercialización como una dimensión. Para obtener información sobre cómo implementar las eVars de comercialización, consulte[eVars](/help/implement/vars/page-vars/evar.md)en la Guía del usuario de implementación.*
...
* Para las variables de comercialización que utilizan sintaxis de variable de conversión, las instancias se cuentan cada vez que se configura la eVar. Sin embargo, se atribuye al valor de la dimensión `"None"` a menos que suceda lo siguiente en la misma visita:
