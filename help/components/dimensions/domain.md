...
El &quot;dominio&quot; [dimensión](overview.md) informa de los puntos de acceso que los visitantes utilizan para acceder a internet.
...
* Para implementaciones de SDK web, habilite [!UICONTROL Búsqueda de red] cuando [configuración de una secuencia de datos](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html?lang=es).
