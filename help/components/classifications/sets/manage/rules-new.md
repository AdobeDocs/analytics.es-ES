...
1. En el cuadro de diálogo **[!UICONTROL Conjunto de clasificaciones: _nombre del conjunto de clasificaciones_]**, seleccione la pestaña **[!UICONTROL Reglas]**.
   ...
   * Si accede a la interfaz **[!UICONTROL Rules]** por primera vez para un conjunto de clasificaciones, o ha decidido hasta ahora seguir utilizando la interfaz heredada del generador de reglas, se le mostrará un cuadro de diálogo que le permitirá seleccionar cómo empezar.

     ![Migración de reglas](assets/rules-migration.png)
...
Puede definir cada regla individual dentro del conjunto de reglas en la interfaz de reglas. La interfaz consta de los siguientes elementos:
...
| 2 | Entrada de la función seleccionada. La entrada depende de la función seleccionada. Por ejemplo, para la función **[!UICONTROL Expresión regular]**, la entrada es una expresión regular. Y para la función **[!UICONTROL Split]**, la entrada es un token. Introduzca la entrada adecuada para la función específica. Por ejemplo, `^(.+)\:(.+)\:(.+)$` para una expresión regular que identifica tres clasificaciones en un código de campaña interno. |
...
Desea definir una regla para asignar `Email` como el valor de la clasificación **[!UICONTROL Channel]** cuando el valor de la dimensión clave Internal Campaign comience por `em` (por ejemplo: `em:FY2025:Summer Sale`).
...
Desea definir una regla para asignar `2025` como el valor de la clasificación **[!UICONTROL Year]** cuando el valor de la dimensión clave Internal Campaign contenga `2025` (por ejemplo: `em:Summer Sale:FY2025`).
...
Desea definir una regla para asignar `Winter Sale` como un valor a la clasificación **[!UICONTROL Type]** cuando el valor de la dimensión clave Internal Campaign contenga `Winter` (por ejemplo: `fb:Winter:FY2024`).
...
Escriba un valor para **[!UICONTROL coincidencias]**. Por ejemplo: `em:Summer:2025`.

#### Caso de uso

Desea definir una regla para asignar `Email` como valor a la clasificación **[!UICONTROL Channel]**, `Summer Sale` como valor a la clasificación **[!UICONTROL Type]** y `2025` a la clasificación **[!UICONTROL Year]**. Pero solo cuando el valor de la dimensión clave Campaña interna coincide con `em:Summer:2025`.
...
![Regla - Coincide](assets/rule-matches.png)

>[!TAB Resultados de pruebas]

![Regla - Coincide](assets/rule-matches-test.png)
...
Escriba un valor para **[!UICONTROL Split]**. Por ejemplo: `:`.

#### Caso de uso

Desea definir una regla que divida los valores de la dimensión clave Campaña interna en las clasificaciones **[!UICONTROL Canal]**, **[!UICONTROL Tipo]** y **[!UICONTROL Año]** en función del `:` **[!UICONTROL Token]**.

>[!BEGINTABS]

>[!TAB Regla]

![Regla - División](assets/rule-split.png)
...
|---|---|
| `(?ms)` | Hacer coincidir toda la expresión regular con una entrada de varias líneas, lo que permite que el comodín `.` coincida con cualquier carácter de nueva línea |
| `(?i)` | Haga coincidir toda la expresión regular para que no distinga mayúsculas de minúsculas |
...
| `$` | Coincide con el final de la línea (o antes de la nueva línea al final) |
| `\A` | Inicio de cadena. |
| `\z` | Final de cadena. |
...
La última regla determina el valor de la clasificación si:
