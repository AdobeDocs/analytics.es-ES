...
| **[!UICONTROL Nombre de identidad]** | Nombre generado por el sistema para la clasificación. Este nombre es un valor de solo lectura y se deriva del nombre de clasificación inicial. El nombre de identidad se utiliza internamente para mantener la clasificación, actuar como el ID de la dimensión sobre la que se puede realizar un informe y no se puede cambiar. |
...
1. En el diálogo **[!UICONTROL Agregar nuevas clasificaciones]**:
   ...
   * Seleccione **[!UICONTROL Examinar]** y elija un archivo de su equipo o red.
   ...
   Cuando no se define ninguna clasificación en el conjunto de clasificaciones de una columna, se muestra una alerta ![Alert](/help/assets/icons/Alert.svg). La alerta explica que una clasificación no está presente en el conjunto de esquemas de clasificación existente y que se crea al importar.
...
| 6/15/26 | El archivo está **no** procesado (el archivo tiene más de 30 días desde la última fecha de modificación/carga). |
...
| 7/31/26 | El archivo actualizado **no se ha** procesado (el archivo actualizado tiene más de 30 días desde la última fecha de modificación o carga). |
