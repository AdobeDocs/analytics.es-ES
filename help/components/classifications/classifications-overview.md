...
* **Los conjuntos de clasificaciones** son los componentes principales para clasificar los datos. [Los conjuntos de clasificaciones](/help/components/classifications/sets/overview.md) le permiten crear y administrar clasificaciones en una sola interfaz simplificada.
