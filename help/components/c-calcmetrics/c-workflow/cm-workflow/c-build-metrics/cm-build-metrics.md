...
# Generar métricas {#build-metrics}
...
1. Acceda al creador de métricas calculadas de cualquiera de las siguientes maneras:
   ...
   * En [!DNL Adobe Analytics], vaya a **[!UICONTROL Componentes]** > **[!UICONTROL Métricas calculadas]** y, a continuación, seleccione **[!UICONTROL + Agregar]** en la parte superior de la página Métricas calculadas.
