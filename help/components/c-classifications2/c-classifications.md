---
description: Una clasificación es una forma de categorizar los datos de variables de Analytics y, a continuación, muestra los datos de diferentes maneras cuando se generan informes.
seo-description: Una clasificación es una forma de categorizar los datos de variables de Analytics y, a continuación, muestra los datos de diferentes maneras cuando se generan informes.
...
Una clasificación es una forma de categorizar los datos de variables de Analytics y, a continuación, muestra los datos de diferentes maneras cuando se generan informes.
...
Consulte [Clasificaciones de tráfico](/help/admin/admin/c-traffic-variables/traffic-classifications.md) y [Clasificaciones de las conversiones](https://marketing.adobe.com/resources/help/en_US/reference/index.html?f=conversion_classifications).
