...
* [**Métricas/dimensiones de Advertising**](/help/components/dimensions/amo-id.md)
* **eVars de contador**
...
* **Variables de lista**
* [**Dimensiones de canales de mercadotecnia**](/help/components/dimensions/marketing-channel.md)
...
* [**eVars que no son de comercialización**](/help/components/dimensions/evar.md) / **eVars reservadas:** Los valores establecidos en una eVar persisten solamente si el valor se estableció dentro del intervalo de fechas del informe debido a la limitación de fechas del Procesamiento de intervalo de tiempo. Además, las caducidades basadas en la hora pueden producirse 60 minutos antes o después si la persistencia se ve afectada por un cambio de hora.
