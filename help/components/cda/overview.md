...
El uso de análisis entre dispositivos requiere [vinculación basada en el campo](field-based-stitching.md).
...
El análisis entre dispositivos es una característica innovadora y sólida, pero tiene limitaciones en la forma de utilizarlo. [La vinculación basada en el campo](field-based-stitching.md) también tiene sus propias limitaciones específicas.
...
* Private Graph aprovecha las mismas sincronizaciones de ID que las sincronizaciones de ID utilizadas por la funcionalidad [Atributos del cliente](https://experienceleague.adobe.com/en/docs/core-services/interface/services/customer-attributes/attributes) ubicada en CX Enterprise y Adobe Analytics. Sin embargo, los grupos de informes virtuales de Cross-Device Analytics (basados en gráficos privados o en la vinculación basada en el campo) no son compatibles con el resto de la funcionalidad Atributos del cliente. Es decir, las dimensiones basadas en atributos del cliente no están disponibles para su uso en los grupos de informes virtuales de análisis entre dispositivos.
