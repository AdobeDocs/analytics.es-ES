...
A continuación se ofrece una descripción general de las [métricas estándar de Analytics](/help/components/c-variables/c-metrics/metrics-overview.md).

Las [métricas calculadas](https://docs.adobe.com/content/help/es-ES/analytics/components/calculated-metrics/cm-overview.html) se crean combinando métricas.
