...
También hemos aumentado el número máximo de segmentos editables de Adobe Analytics a 75 (de 20). You can view published segments in [!UICONTROL Analytics > Components > Segments].
