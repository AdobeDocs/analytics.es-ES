...
* [Mayo de 2014](/help/components/c-segmentation/whats-new-segmentation.md)
...
<table id="table_57C605AE55CF415483F87676D9322EB6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ahora, al crear segmentos secuenciales, se puede filtrar por tráfico “antes de la secuencia” o “después de la secuencia”. </p> <p> <p>Nota: Tenga en cuenta que esta función no está disponible en Ad Hoc Analysis. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Restricciones de dimensión con segmentos secuenciales </p> </td> 
   <td colname="col2"> <p>En una cláusula “En”, entre instrucciones THEN, se puede agregar, por ejemplo, “En 1 instancia de palabra clave de búsqueda”, “En 1 instancia de eVar 47”. Esto restringe el segmento a una instancia de una dimensión. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Analysis Workspace: <a href="https://docs.adobe.com/content/help/es-ES/analytics/analyze/analysis-workspace/visualizations/fallout/fallout-flow.html"  >Utilizar segmentos en el análisis de visitas en el orden previsto </a> </p> </td> 
...
<table id="table_0BA171FFB5AE4547A06143630D80F021"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Si los usuarios no tienen el <a href="https://docs.adobe.com/content/help/es-ES/analytics/admin/user-product-management/user-groups/groups.html"  >permiso Crear segmento</a>, ya no pueden acceder al Generador de segmentos. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_78CCF0B5ECF14FCF9C7C98F63AA6D42A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>El usuario administrador puede delimitar los usuarios que pueden crear segmentos nuevos. De forma predeterminada, todos los usuarios pueden crear segmentos. <a href="https://docs.adobe.com/content/help/es-ES/analytics/admin/user-product-management/user-groups/groups.html"  > Más...</a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_789DB70764434C7CA9D5EDD17CCC53D7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Reports &amp; Analytics y Ad Hoc Analysis ahora usan operadores consistentes y nombres de operadores al crear segmentos. </p> <p><b>Operadores nuevos</b> </p> <p>Los operadores <span class="wintitle">existe</span> y <span class="wintitle">no existe</span> se añadieron a Reports &amp; Analytics al segmentar según las cadenas enumeradas. </p> <p>Los operadores <span class="wintitle">no contiene todo de</span> y <span class="wintitle">no contiene nada de</span> se añadieron a los Ad Hoc Analysis al segmentar según los valores de las cadenas. </p> <p><b>Operadores con nombre cambiado</b> </p> <p>En Reports &amp; Analytics: </p> 
...
<table id="table_E19F6041088C4C4F862A7FCAC9AC9BE3"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Compatibilidad para las coincidencias y no coincidencias en los segmentos del Data Warehouse </p> </td> 
   <td colname="col2"> <p>Data Warehouse ahora es compatible con las coincidencias y las no coincidencias en las definiciones de segmentos. (Reports &amp; Analytics y Ad Hoc Analysis ya los admiten). </p> <p>En la próxima versión serán compatibles los segmentos que anteriormente eran incompatibles con Data Warehouse, ya que Data Warehouse no era compatible con los parámetros “coincide” y “no coincide” (en el caso de que este fuera el único motivo de que los segmentos fueran incompatibles). Con la nueva versión, es posible que se muestren segmentos adicionales en la lista de segmentos del Data Warehouse. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_6FED9044F8194F299B33038831B2C12B"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Reports &amp; Analytics: capacidad de crear segmentos de informes de visitas en el orden previsto </p> </td> 
