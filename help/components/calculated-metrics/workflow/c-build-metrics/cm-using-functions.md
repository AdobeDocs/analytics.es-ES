...
Para obtener una lista de todas las funciones, consulte [Funciones básicas](/help/components/calculated-metrics/cm-reference/cm-functions.md) y [Funciones avanzadas](/help/components/calculated-metrics/cm-reference/cm-adv-functions.md).
