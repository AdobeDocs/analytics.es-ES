...
| Columna | Descripción |
| --- | --- |
| ![StarOutline](/help/assets/icons/StarOutline.svg) | Seleccione para favorecer a ![Estrella](/help/assets/icons/Star.svg) o dejar de favorecer a ![EsquemaDeEstrella](/help/assets/icons/StarOutline.svg) en una métrica calculada. See [Mark calculated metric as favorite](cm-favorite.md) |
...
| ![Etiqueta](/help/assets/icons/Label.svg) | **[!UICONTROL Etiqueta]** | Etiquete las métricas calculadas seleccionadas. In the **[!UICONTROL Tag Calculated metric]** dialog, select or de-select the tags for the selected calculated metric. Seleccione **[!UICONTROL Guardar]** para guardar las etiquetas de las métricas calculadas seleccionadas. See [Tag calculated metrics](cm-tagging.md) for more information. |
