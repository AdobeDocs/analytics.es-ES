...
En la mayoría de los casos, se utiliza un complemento para rellenar variables de la cadena de consulta. Si algún error tipográfico o un problema similar impide que se rellene el valor, puede rellenar la variable utilizando reglas de procesamiento.
