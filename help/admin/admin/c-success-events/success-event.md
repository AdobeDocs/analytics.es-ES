...
5. Busque el evento deseado y modifique el cuadro desplegable [!UICONTROL Registro de un solo evento] a [!UICONTROL Registrar una vez por visita] o [!UICONTROL Usar ID de evento].
