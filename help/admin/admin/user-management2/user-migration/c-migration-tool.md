 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Estos seguirán estando disponibles en la administración de usuarios de Analytics. </p> <p>Consulte <a href="/help/admin/admin/user-management2/user-migration/c-migration-tool.md"> Funciones de Analytics no soportadas en Adobe Admin Console</a> para obtener más información. </p> </td> 
  </tr> 
  <tr> 
