...
description: Cree y configure variables de lista para utilizarlas en los informes.
...
Cree y configure variables de lista para utilizarlas en los informes. Defina aquí sus valores de delimitador, caducidad, asignación y máximo.
