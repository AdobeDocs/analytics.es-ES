...
* Si no especifica el uso de la expansión de ID, pero va a utilizar una mezcla de ID de dispositivo y persona para distintas solicitudes, le recomendamos especificar tanto la etiqueta DEL-DEVICE como DEL-PERSON para las variables que se deben eliminar cuando se utiliza cualquiera de los dos tipos de ID.
