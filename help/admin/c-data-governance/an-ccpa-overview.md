...
* Considere implementar las [Variables de administración de consentimiento](/help/admin/admin/privacy-reporting.md) para rastrear el estado de consentimiento en un nivel de visita individual.
