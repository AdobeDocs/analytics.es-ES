---
description: Permite controlar el acceso a los datos de creación de informes. Las opciones incluyen contraseñas seguras, caducidad de las contraseñas, restricciones de inicio de sesión de direcciones IP y restricciones de dominio de correo electrónico.
...
| --- | --- |
| Requiere contraseñas sólidas | Forza a los usuarios a crear contraseñas más seguras que se adhieren a las reglas siguientes: <ul><li>Debe tener al menos ocho caracteres de longitud.</li><li>Debe tener al menos un símbolo o número entre los caracteres primero y último.</li><li>Debe tener al menos un carácter alfa.</li><li>No se puede encontrar en un diccionario o contener palabras de un diccionario (inglés).</li><li>No puede incluir tres (3) caracteres consecutivos del nombre de usuario de inicio de sesión.</li><li>Debe ser diferente a las 10 contraseñas anteriores.</li></ul>**Nota**: Esta función se refuerza en las nuevas contraseñas a partir de este momento. No comprueba las contraseñas anteriores ni obliga a los usuarios a cambiar sus contraseñas actuales. Por este motivo, considere la posibilidad de habilitar la caducidad de la contraseña para obligar a los usuarios a cambiar sus contraseñas y adherirse a las reglas de contraseña segura. |
| Caducidad de la contraseña | Obliga a los usuarios a cambiar su contraseña de cuenta de usuario de forma regular. Puede especificar el intervalo con el que desea que las contraseñas caduquen y forzar que las contraseñas caduquen inmediatamente. |
