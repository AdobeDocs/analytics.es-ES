...
Para ahorrar tiempo al crear un nuevo grupo de informes, puede seleccionar una plantilla similar a la configuración del grupo de informes que ha diseñado. La selección de una plantilla de grupo de informes no limita la implementación de ninguna manera. Cualquier configuración realizada por una plantilla de grupo de informes se puede cambiar después de crear el grupo de informes.

[Más información](/help/admin/tools/manage-rs/rs-templates/default-rs-template.md)
