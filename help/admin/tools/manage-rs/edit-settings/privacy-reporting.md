...
1. Haga clic en **[!UICONTROL Habilitar informes de privacidad de datos]**.
   ...
   >[!NOTE]
   >
   >Una vez estas variables estén habilitadas, no se pueden deshabilitar.

   ![Habilitar](assets/rsm-privacy-enable.png)

1. Una vez habilitadas, aparece un mensaje de confirmación. Las dimensiones están disponibles en los informes.
