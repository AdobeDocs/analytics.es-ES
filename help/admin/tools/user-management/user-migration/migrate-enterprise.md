...
# Migración de las cuentas de usuario de Analytics para Enterprise ID y Federated ID
...
Para nuevos dominios y directorios, siga los pasos para:

* Configurar un directorio
* Configuración de dominios
* Vincular dominios a directorios

Consulte [Configurar un sistema de identidad](https://helpx.adobe.com/es/enterprise/using/set-up-identity.html) para obtener ayuda.

Si ya se creó un directorio en otra organización mediante otra unidad de negocio o equipo, siga los pasos de [confianza de directorios](https://helpx.adobe.com/es/enterprise/using/set-up-identity.html#Directorytrusting) para establecer el directorio en la organización que está utilizando para Analytics.
...
* Descargar una lista de inicios de sesión desde **[!UICONTROL Analytics]** > **[!UICONTROL Usuarios de Analytics y Assets]**.

* Descargar una lista de usuarios actuales de **[!UICONTROL Admin Console]** > **[!UICONTROL Usuarios]**.
...
Si necesita migrar cuentas de usuario de Adobe ID existentes a un Enterprise ID o Federated ID, póngase en contacto con el Servicio de atención al cliente de Adobe y solicite un [conmutador de identidad de usuario en masa](https://helpx.adobe.com/es/enterprise/using/bulk-operations.html).
...
1. Descargue el archivo de inicios de sesión de usuario de Analytics ([!DNL User Logins List.tab]) desde Administración de usuarios de Analytics utilizando uno de los métodos siguientes (en función de si ya ha migrado o no a los usuarios).
   ...
   1. *Si ya ha migrado usuarios,* vaya a **[!UICONTROL Analytics]** > **[!UICONTROL Usuarios y activos de Analytics]**.
      ...
      ![Información sobre los pasos](/help/admin/tools/user-management/user-migration/assets/admin-analytics-users-assets.png)

   1. En la página [!DNL Users], seleccione usuarios y luego haga clic en **[!UICONTROL Exportar a CSV]**.

      ![Información sobre los pasos](/help/admin/tools/user-management/user-migration/assets/export-csv-migrate.png)
...
1. En [!UICONTROL Admin Console], descargue una lista de usuarios de Adobe Admin Console:
   ...
   1. Compare los dos archivos: los usuarios de Adobe Admin Console existentes del archivo [!DNL .csv] exportado ([!DNL sample.csv], en este ejemplo) y los usuarios del archivo [!DNL User Logins List.csv] de Analytics.
      ...
      >[!IMPORTANT]
      >
      >Si encuentra duplicados, elimínelos del archivo [!DNL User Logins List.csv] de Analytics. Este paso ayuda a evitar sobrescribir los permisos de usuario de CX Enterprise existentes en Adobe Admin Console y le proporciona una lista de cuentas a migrar.
...
1. Descargue la plantilla CSV de Adobe Admin Console:
   1. En la ficha Usuarios, haga clic en **[!UICONTROL Añadir usuarios mediante CSV]** y luego en **[!UICONTROL Descargar plantilla CSV]**.
      ...
      ![Información sobre los pasos](/help/admin/tools/user-management/user-migration/assets/add-users-csv.png)
...
1. Haga clic en **[!UICONTROL Migrar]** > **[!UICONTROL Migrar como Enterprise ID]**.
   ...
   ![Información sobre los pasos](/help/admin/tools/user-management/user-migration/assets/migrate-as-enterprise.png)
   ...
   Los usuarios de Adobe ID que aparecen en la herramienta de migración también pueden migrar en este proceso. Aún deben iniciar sesión con su Adobe ID hasta que se realice un cambio de identidad. Póngase en contacto con el Servicio de atención al cliente de Adobe para obtener ayuda con un conmutador de identidad.
