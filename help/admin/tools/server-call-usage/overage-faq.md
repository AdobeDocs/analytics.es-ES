...
| P: ¿Son los detalles de [!UICONTROL Uso de llamadas al servidor] y de asignación específicos de una empresa de inicio de sesión? | R: No. Los detalles de uso y asignación mostrados abarcan todas las empresas de inicio de sesión regidas por el contrato de Adobe Analytics. |
...
| P: ¿Es el periodo de uso siempre el mismo que la duración de mi contrato o ciclo de facturación de Analytics? | R: No. El periodo de uso es la duración durante la cual se aplica la asignación de llamada al servidor y puede diferir de la línea horaria del contrato o del ciclo de facturación. Por ejemplo, su contrato anual podría darle derecho a mil millones de llamadas al servidor por mes, en cuyo caso su compromiso sería mil millones de llamadas al servidor y su periodo de uso sería de un mes. |
...
| P: Mi contrato no incluye una disposición para llamadas al servidor secundarias, pero sigo viéndolas en las pestañas [!UICONTROL Uso actual] y [!UICONTROL Uso del grupo de informes]. ¿Es un error? | R: No. Aunque en el contrato no se aprovisionan explícitamente llamadas secundarias al servidor, aún puede incurrir en ellas si envía datos de Analytics a más de un grupo de informes. Puede revisar su implementación para asegurarse de que no está enviando dichas llamadas o ponerse en contacto con su equipo de cuenta de Adobe para actualizar su contrato y que incluya una disposición para dichas llamadas. |
| P: Mi contrato no incluye una disposición para llamadas al servidor secundarias, pero sigo viéndolas en las pestañas [!UICONTROL Uso actual] y [!UICONTROL Uso del grupo de informes]. ¿Significa esto que empezaré a incurrir en cargos adicionales? | R: Depende del contrato que tenga con usted si empezará a incurrir en excesos cuando envíe llamadas secundarias al servidor sin que se le hayan aprovisionado. En algunos casos, el consumo de llamadas al servidor secundarias puede descontar su asignación para llamadas al servidor primarias, agotándolas a una velocidad más rápida de lo previsto. En otros casos, se le podrían facturar llamadas al servidor secundarias aunque no haya consumido todas sus llamadas al servidor primarias. Consulte el contrato o póngase en contacto con el equipo de cuenta de Adobe para confirmarlo. |
| P: Mi contrato/periodo de uso acaba de empezar y ya estoy recibiendo alertas por haber superado mi asignación de llamadas al servidor secundarias. ¿Es un error y se me empezarán a facturar cargos adicionales? | R: No. Esto podría significar que está consumiendo llamadas secundarias al servidor sin que se aprovisionen explícitamente como parte de su contrato de Adobe Analytics. La alerta sirve simplemente para asegurarse de que es consciente de esto y para permitirle tomar medidas correctivas, si es necesario. Véase también la pregunta frecuente 8 supra. |
