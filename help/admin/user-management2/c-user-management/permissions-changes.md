...
>[!NOTE] Debido al alto número de combinaciones de permisos posibles, no se puede proporcionar documentación que describa todos los métodos API que se pueden utilizar en cada combinación de permisos. Generalmente, los no administradores a los que se les concede acceso a los servicios Web solo tendrán acceso de lectura a los métodos de API. No tendrán acceso de escritura a los métodos.

Dado que la API y la interfaz utilizan el mismo sistema de permisos, los permisos que un administrador de la interfaz (Adobe Admin Console) haya concedido a un usuario que no sea administrador determinado serán los mismos que el usuario en la API.
...
<table id="table_D1DB0DE37752450BBCCA44DB760BB505"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Cambios en grupos predefinidos </p> </td> 
   <td colname="col2"> <p> <b>Acceso del administrador:</b> Los grupos predefinidos ya no son necesarios para los administradores. Los administradores ahora tienen acceso a todos los elementos (herramientas, métricas, dimensiones), así como al acceso al servicio Web, al Creador de informes, al mapa de Actividad y a la Análisis ad hoc. </p> <p>A partir de ahora, el propósito de los grupos es conceder o restringir el acceso a usuarios no administrativos. </p> <p> <b>Grupos personalizados:</b> Los grupos personalizados reemplazaron a los grupos predefinidos. Los grupos predefinidos existentes se migrarán a grupos personalizados con el mismo nombre de grupo. Se conservarán todos los grupos personalizados que haya creado, incluida su configuración. Sin embargo, observará que la ubicación de la configuración se habrá movido. Por ejemplo, los ajustes de configuración de la empresa (en Admin Console personalizado) están ahora en <a href="/help/admin/user-management2/c-customize-report-access/groups-analytics-tools.md"> Personalizar herramientas de Analytics</a>. </p> <p> Los usuarios que pertenecen a <span class="term"> Acceso a todos los informes</span> se han migrado a un grupo personalizado con acceso a: </p> 
    <ul id="ul_696A9243F5FD4AF187352C2F4B1CFDC2"> 
     ...
     <li id="li_AFFB58C7FB644AC8A85E2D76BA7D51F5">Permiso de acceso al área de trabajo de Análisis </li> 
  ...
  <tr> 
   <td colname="col1"> <p>Permisos de nivel de dimensión </p> </td> 
   <td colname="col2"> <p>Puede personalizar permisos para incluir o excluir el acceso a dimensiones (además de métricas). </p> 
...
A continuación encontrará información importante sobre las actualizaciones nuevas y planificadas y cómo afectan a su entorno administrativo.
...
<table id="table_1E93F45C66E841E6882FB602509F30A3"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1">¿Qué cambios en los permisos se produjeron en la versión de <b>julio de 2016</b> ? </td> 
  ...
  <tr> 
   <td colname="col1"> <p>¿Hay algo que necesite hacer para migrar usuarios? </p> </td> 
   <td colname="col2"> <p>No, todas las migraciones de permisos se producirán de forma transparente. </p> <p> 
     <ul id="ul_654F85286EC04416B3E0BA725EBE10AD"> 
      <li id="li_8050B8941F794103B82A0ADF0930D216">Todos los informes de tráfico actuales de un grupo personalizado se migrarán automáticamente a la nueva Categoría de dimensión. </li> 
      <li id="li_B97079DB29A346B98D066F11AB7F94AF">Si un grupo personalizado tiene métricas ya habilitadas, se le asignarán automáticamente todas las dimensiones con permisos nuevos (eVars y variables de solución). </li> 
      <li id="li_F1219EF490DA473BA15F2B215F2995AE"> A un grupo personalizado con al menos una métrica se le otorgará automáticamente acceso a todas las eVars y otras dimensiones según el contenido, <b>excepto</b> a las dimensiones de tráfico recién disponibles (anteriormente informes de tráfico). </li> 
      <li id="li_F494CE6144A04A6199CFBBA1D7BEA32B">Cada grupo predefinido se cambiará a un permiso. Estos nuevos permisos se agregarán a una nueva categoría <span class="uicontrol">Herramientas de Analytics</span>. </li> 
      <li id="li_2FCD9254FC3C4FD7871EEF9453E5CE1E">Todos los grupos personalizados con métricas tendrán todos los eventos de soluciones de Analytics agregados como métricas nuevas. </li> 
      <li id="li_34C4560769B64F28A4E83BAE71065DCC">Todos los usuarios que antes estaban en Acceso a todos los informes se agregarán al nuevo grupo personalizado. Ya no existirá Acceso a todos los informes. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>¿Qué no cambiará? </p> </td> 
   <td colname="col2"> <p>Los atributos de Visitante seguirán sin tener permiso. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE] *`migrated user`* y *`Experience Cloud user`* hacen referencia a usuarios que han aceptado una invitación por correo electrónico para unirse a Experience Cloud. Si no se acepta la invitación por correo electrónico, los usuarios seguirán siendo usuarios de Analytics y no podrán gestionarse desde Admin Console. (La excepción es si la migración utiliza [Enterprise ID o Federated ID](https://helpx.adobe.com/es/enterprise/using/set-up-identity.html). En este caso, el usuario se migra cuando el administrador migra a los usuarios de forma individual).

<table id="table_B68FD00FC5D24823A86BB69558C0327C"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Tarea </th> 
   <th colname="col2" class="entry"> Compañía de inicio de sesión no migrante </th> 
   <th colname="col3" class="entry"> Migrando Compañía actualmente </th> 
   <th colname="col4" class="entry"> Finalizó la migración de la Compañía de inicio de sesión </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <a href="https://adminconsole.adobe.com/enterprise/"> Admin Console</a> </p> <p> Herramientas de administración: la edición está limitada a la administración de claves de API y a la eliminación/transferencia de recursos. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>Experience Cloud: </b> marketing.adobe.com <span class="filepath"></span>. Solo disponible para usuarios de Experience Cloud. </p> <p> <b>Analytics (heredado):</b> <span class="filepath">sc.omniture.com</span>. Solo para usuarios de Analytics y para usuarios de Experience Cloud con sus credenciales de Analytics </p> </td> 
