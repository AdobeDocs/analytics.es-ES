...
+ Gobierno de datos {#data-governance}
   ...
   + [Flujo de trabajo del RGPD en Adobe Analytics](c-data-governance/an-gdpr-workflow.md)
   ...
   + [Etiquetas del RGPD para variables de Analytics](c-data-governance/gdpr-labels.md)
