...
+ Analytics Admin overview {#admin-overview}
   + [¿Qué herramienta de Adobe Analytics debo utilizar?](c-analytics-product-comparison/which-analytics-tool.md)
   + [Comparación de productos y requisitos de Analytics](c-analytics-product-comparison/analytics-product-comparison.md)
+ [Requisitos del sistema](c-system-requirements/sys-reqs.md)
+ Herramientas de administración {#admin-tools}
   ...
   + Detección de búsqueda de pago {#paid-search-detection}
      + [Información general sobre detección de búsqueda paga](admin/paid-search-detection/paid-search-detection.md)
   ...
   + Reglas de procesamiento {#processing-rules}
      + [Información general sobre reglas de procesamiento](admin/c-processing-rules/processing-rules.md)
      + Processing rules configuration {#processing-rules-configuration}
         + [Cómo funcionan las reglas de procesamiento](admin/c-processing-rules/c-processing-rules-configuration/processing-rules-about.md)
      ...
      + Processing rules examples {#processing-rules-examples}
         ...
         + [Rellene un ID de campaña desde un parámetro de cadena de consulta](admin/c-processing-rules/processing-rules-examples/processing-rules-populate-campaign-id.md)
         + [Configure el evento de vista del producto desde la página de información general del producto](admin/c-processing-rules/processing-rules-examples/setting-the-product-view-event.md)
         + [Agregue una subcategoría concatenando la categoría y el nombre de página](admin/c-processing-rules/processing-rules-examples/subcategory-concatenating.md)
         + [Determinar una ruta copiando un valor evar en una prop](admin/c-processing-rules/processing-rules-examples/processing-rules-determining-path.md)
         + [Limpiar valores en un informe](admin/c-processing-rules/processing-rules-examples/clean-up-values-in-a-report.md)
         + [Rellene los términos de búsqueda interna utilizando un parámetro de cadena de consulta](admin/c-processing-rules/processing-rules-examples/processing-rules-populating-internal-search.md)
         + [Copia de una variable de datos de contexto a una evar](admin/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data.md)
         + [Configurar un evento usando una variable de datos de contexto](admin/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data-event.md)
         + [Eliminar un evento de una visita](admin/c-processing-rules/processing-rules-examples/processing-rules-remove-event.md)
      + [Consejos y trucos de reglas de procesamiento](admin/c-processing-rules/processing-rules-tips.md)
   + Informes en tiempo real{#real-time-reports}
      + [Información general sobre los informes en tiempo real](admin/realtime/realtime.md)
      + [Configuración de informes en tiempo real](admin/realtime/t-realtime-admin.md)
      + [Dimensiones y métricas en tiempo real compatibles](admin/realtime/realtime-metrics.md)
   + [Cola de informes programados](admin/scheduled-reports-admin.md)
   + Server-side forwarding {#server-side-forwarding}
      + [Descripción general del reenvío del lado del servidor](admin/c-server-side-forwarding/ssf.md)
      + [Requisitos para el reenvío del lado del servidor](admin/c-server-side-forwarding/ssf-requirements.md)
      + [Referencia de código y datos del reenvío del lado del servidor](admin/c-server-side-forwarding/ssf-reference.md)
      + [Cómo verificar la implementación de reenvío del lado del servidor](admin/c-server-side-forwarding/ssf-verify.md)
      + [Preguntas frecuentes sobre reenvío de servidor](admin/c-server-side-forwarding/ssf-faq.md)
   ...
   + Eventos de éxito {#success-events}
      + [Información general sobre los eventos de éxito](admin/c-success-events/success-event.md)
      + [Configurar eventos de éxito](admin/c-success-events/t-success-events.md)
      + [Acerca del cambio del tipo de evento](admin/c-success-events/event-type.md)
   + [Marcas de hora opcionales](admin/timestamp-optional.md)
   + Traffic variables {#traffic-variables}
      + [Descripción general de variable de tráfico (prop)](admin/c-traffic-variables/traffic-var.md)
...
+ Experience Cloud Admin Console {#admin-console}
   ...
   + [Guía de administración de Adobe Analytics First Admin](admin-console/first-admin-guide.md)
   + [Crear un grupo de informes](admin-console/create-report-suite.md)
+ Configuración de la empresa {#company-settings}
   + [Descripción general de la configuración de la empresa](company/c-company-settings.md)
   + [Niveles de acceso de funciones](company/feature-access-levels.md)
   + [Servicios Web](company/web-services-admin.md)
   + [Informes del creador de informes](company/report-builder-reports-admin.md)
...
+ Manage report suites {#manage-report-suites}
   ...
   + Report suite templates {#report-suite-templates}
      + [Descripción general de las plantillas de grupos de informes](c-manage-report-suites/c-report-suite-templates/report-suite-templates.md)
      + [Portal de agregación](c-manage-report-suites/c-report-suite-templates/aggregator-portal.md)
   ...
   + New report suite {#new-report-suite}
      ...
      + [Nuevo grupo de informes: configuración](c-manage-report-suites/c-new-report-suite/new-report-suite.md)
...
+ User and Product Management (Legacy) {#user-product-management}
   ...
   + Administración de usuarios {#user-management}
      + [Información general sobre administración de usuarios](user-management2/c-user-management/users.md)
      + [Agregar una cuenta de usuario](user-management2/c-user-management/t-add-user-account.md)
      + [Cambios en los permisos de usuario y grupo](user-management2/c-user-management/permissions-changes.md)
   ...
   + Customize report access {#customize-report-access}
      + [Personalizar el acceso a los informes: información general](user-management2/c-customize-report-access/groups-customize-report-access.md)
      + [Personalizar permisos de herramientas de Analytics](user-management2/c-customize-report-access/groups-analytics-tools.md)
      + [Personalizar permisos de herramientas de grupos de informes](user-management2/c-customize-report-access/groups-report-suite-tools.md)
      + [Personalizar permisos de métricas](user-management2/c-customize-report-access/groups-metrics.md)
      + [Personalizar permisos de dimensiones](user-management2/c-customize-report-access/groups-dimensions.md)
...
+ Gobierno de datos {#data-governance}
   ...
   + [Flujo de trabajo del RGPD de Adobe Analytics](c-data-governance/an-gdpr-workflow.md)
   + [Ver/administrar la configuración de administración de datos del grupo de informes](c-data-governance/gdpr-view-settings.md)
   + [Etiquetar datos del grupo de informes](c-data-governance/gdpr-setup-reportsuite.md)
   + [Enviar acceso y eliminar solicitudes](c-data-governance/gdpr-submit-access-delete.md)
   + [Etiquetas RDPD para variables de Analytics](c-data-governance/gdpr-labels.md)
   + [Espacios de nombres](c-data-governance/gdpr-namespaces.md)
   + [Expansión de ID](c-data-governance/gdpr-id-expansion.md)
   + [Optimizaciones de etiquetado](c-data-governance/gdpr-analytics-ids.md)
   + [Ejemplo de etiquetado](c-data-governance/gdpr-labeling-example.md)
   + [RGPD y Data Connectors (Genesis)](c-data-governance/data-connectors-gdpr.md)
   + [Terminología del RGPD](c-data-governance/gdpr-terminology.md)
+ Uso de llamadas al servidor {#server-call-usage}
   + [Descripción general del uso de llamadas al servidor](c-server-call-usage/overage-overview.md)
   + [Ver el uso actual de llamadas al servidor](c-server-call-usage/server-call-usage-dashboard.md)
   + [Ver el uso del grupo de informes](c-server-call-usage/report-suite-usage.md)
