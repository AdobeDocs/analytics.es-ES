...
Lo que debe saber sobre la migración de ID de usuario de Analytics a Adobe Admin Console en Adobe Experience Cloud.

Para obtener ayuda en general sobre los temas de Adobe Admin Console (no relacionados con la migración de Analytics), consulte [Guía del usuario del Admin Console](https://helpx.adobe.com/es/enterprise/administering/user-guide.html).

Después de migrar, puede [administrar usuarios y productos de Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/manage-users-and-products/admin-getting-started.html?lang=es) en Adobe Admin Console.
...
Las ventajas de utilizar Adobe Admin Console incluyen:
...
<table id="table_36FD7EF1DAB44D359F4FC186D93147E5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe notificará por correo electrónico a los administradores de Analytics instrucciones sobre el comienzo de la migración. </p> <p>Las migraciones a Adobe Admin Console se producirán en oleadas. El día de la migración, Adobe notifica a los administradores de Analytics y les otorga acceso a la herramienta de migración. Una vez que una empresa de inicio de sesión cumpla los criterios definidos para cada etapa de la migración, Adobe: </p> 
    ...
    <ul id="ul_4639963EB08F407F8C18ACE2B3D30223"> 
     <li id="li_7F24A3FC900146C3B2E988D399C859EA">Los administradores utilizarán Adobe Admin Console para administrar sus usuarios y permisos de Analytics. (Ya no tendrá que utilizar la interfaz de administración de usuarios de Analytics &gt; Administración &gt; Administración de usuarios). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En la fecha de inicio de la migración, a las 10:00 horas UTC: </p> 
    <ul id="ul_25D1DBDF5C804D048E741F31550FF5F3"> 
     <li id="li_418476105FE341229CE146E730AAB33D">Los grupos de permisos existentes en Analytics se replicarán automáticamente en Adobe Admin Console como perfiles de producto, incluida su descripción y permisos granulares en grupos de informes, métricas, dimensiones, Analytics y herramientas de grupos de informes. </li> 
     <li id="li_412F88C454B0455A8F3BC8016226855C">Si alguno de los usuarios actuales de Analytics se creó en Adobe Admin Console (es decir, tiene un Adobe o Enterprise ID vinculado), se agregarán a los perfiles de producto correspondientes en Adobe Admin Console. </li> 
     <li id="li_8A05137EC05C4FD5910E73FE58300DCB">La sección Administración de usuarios de la ficha Administración de Analytics pasará a ser de <span class="term"> solo lectura</span>. Aquí ya no podrá crear usuarios ni grupos de permisos nuevos y deberá realizar ambas funciones en Adobe Admin Console. Consulte <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md#section-928ffba27a0446e0af575b720434ef56"> Funciones de Analytics no soportadas en Adobe Admin Console</a> para obtener más información. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sí. Sin embargo, Adobe le recomienda que aproveche el tiempo previo a la migración para: </p> 
    <ul id="ul_52C7EC44A5534975BFD7A6F37A829C25"> 
     <li id="li_8CFFF72877E8456DAC3241143AD648AD">Compruebe que es administrador de productos de Analytics en Adobe Admin Console. </li> 
  ...
  <tr> 
   <td colname="col1"> <p> Soy administrador de Analytics sin acceso a Adobe Admin Console. ¿Quién puede ayudarme a obtener acceso a Adobe Admin Console? </p> </td> 
   <td colname="col2"> <p>Cualquier administrador de sistemas o productos que tenga acceso a Adobe Admin Console de su organización podrá proporcionarle acceso. Si no sabe con seguridad qué persona de su organización dispone de privilegios de administrador en la consola, póngase en contacto con el <a href="https://helpx.adobe.com/marketing-cloud/contact-support.html">servicio de atención al cliente de Adobe</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Ahora que mi empresa está migrando a Adobe Admin Console, ¿dónde creo nuevos usuarios y grupos de permisos antes de la fecha de inicio de la migración? </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Próximamente habrá disponible en Adobe Admin Console una herramienta que le permitirá cambiar los tipos de ID de Adobe de Federated ID a Federated ID. Durante la migración, no puede migrar usuarios como Federated ID. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_0E37BB1DEA6143F0B5F4E861FCFA7189"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>¿Puedo crear usuarios y grupos de permisos en Analytics después de que empiece la migración y, a continuación, utilizar la herramienta de migración para moverlos a Adobe Admin Console? </p> </td> 
   <td colname="col2"> <p> No. Una vez que comience la migración, todos los usuarios y grupos de permisos nuevos (llamados perfiles de producto en Adobe Admin Console) deben crearse en Adobe Admin Console. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La herramienta de migración incluye un panel de control que muestra cuántos usuarios se han migrado correctamente y cuántos de ellos tienen el inicio de sesión heredado desactivado. </p> <p> Lo ideal es que haya migrado correctamente su empresa de inicio de sesión a Adobe Admin Console cuando el 100 % de los usuarios hayan completado la migración y hayan deshabilitado sus inicios de sesión heredados. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Una vez que comience la migración, utilizará Adobe Admin Console para crear y administrar nuevos usuarios y perfiles de producto. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>No. Debe utilizar la herramienta de migración para asegurarse de que todos los usuarios existentes se migren a Adobe Admin Console. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Estos seguirán estando disponibles en la administración de usuarios de Analytics. </p> <p>Consulte <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md"> Funciones de Analytics no soportadas en Adobe Admin Console</a> para obtener más información. </p> </td> 
  </tr> 
  <tr> 
...
## Funciones de Analytics no soportadas en Adobe Admin Console {#section-928ffba27a0446e0af575b720434ef56}
...
<table id="table_88E2FA03D5F241B79AB54D12F64B51DA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Los administradores que realizan la migración a Adobe Admin Console ya no podrán utilizar la función "Iniciar sesión como" para acceder a cuentas de usuario que no sean de administrador migradas a Adobe Admin Console. Esta función se va a dejar de utilizar con Analytics. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Los administradores que realizan la migración a Adobe Admin Console deben configurar<a href="https://developer.adobe.com/UMAPI/"> API de administración de usuarios</a> disponible en Adobe Developer para acceso programático a cuentas de usuario en Adobe Admin Console. </p> <p>Las API de permisos de Analytics se desactivarán cuando se habilite su migración. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Credenciales del servicio web </p> </td> 
   <td colname="col2"> <p> Las credenciales del servicio web de los usuarios (y su secreto compartido) no estarán disponibles en Adobe Admin Console y se puede acceder a ellas haciendo clic en el usuario específico en la sección Usuarios y recursos de Analytics . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Inicio de sesión único </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>El correo electrónico masivo a los usuarios ya no estará disponible en las herramientas de administración de Analytics ni en Adobe Admin Console. Los clientes pueden exportar por lotes las direcciones de correo electrónico de los usuarios de Admin Console de Adobe y enviar un correo electrónico mediante el uso del cliente de correo que deseen. </p> </td> 
  </tr> 
 </tbody> 
</table>
