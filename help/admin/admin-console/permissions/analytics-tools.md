...
| [!UICONTROL Acceso a la IU de Herramientas de administración] | No se usa. |
...
| [!UICONTROL Acceso a la interfaz de usuario de configuración de empresa] | No se usa. |
...
| [!UICONTROL Acceso a la IU de etiquetado de privacidad y administración de datos] | Otorga acceso a Administración > Etiquetado de privacidad de administración de datos. |
...
| [!UICONTROL Acceso a Labs] | Proporciona a los usuarios acceso a Labs y a los prototipos dentro de Labs. |
| [!UICONTROL Report Builder heredado] | Permite al usuario autenticarse con el complemento Report Builder heredado en Microsoft Excel. |
...
| [!UICONTROL Acceso a MCP] | Otorga acceso para usar [Adobe Analytics MCP server](https://developer.adobe.com/analytics-mcp/docs/aa/). Este elemento de permiso es necesario para todos los usuarios, incluidos los administradores de productos, para poder utilizar esta herramienta. |
...
| [!UICONTROL Acceso a la IU de administración de grupos de informes] | Otorga acceso a Administración > Grupos de informes, pero no permite editar ninguna configuración ni crear grupos de informes. Use los elementos de permiso de las [herramientas del grupo de informes](report-suite-tools.md) para permitir a los usuarios editar selectivamente la configuración del grupo de informes. |
| [!UICONTROL Acceso a la IU de Reporting Activity Manager] | Otorga acceso a Administración > Administrador de actividades de creación de informes. |
...
| [!UICONTROL Publicación de segmentos] | Concede la capacidad de convertir un segmento en una audiencia de CX Enterprise al crear o editar un segmento. |
