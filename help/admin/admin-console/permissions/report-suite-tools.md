...
Esta tabla enumera todos los elementos de permisos en Herramientas de grupos de informes al configurar un perfil de producto en Adobe Admin Console. Estos elementos de permiso solo se aplican a los grupos de informes incluidos en el mismo perfil de producto. Si el perfil de producto actual no contiene ningún grupo de informes, incluyendo estos permisos no hará nada.
...
| [!UICONTROL Páginas de bots] | No se usa. |
| [!UICONTROL Bots] | No se usa. |
...
| [!UICONTROL Informe de canal] | No se usa. |
...
| [!UICONTROL Visitas de retorno diario] | No se usa. |
...
| [!UICONTROL Informe breve de prueba del panel de R&amp;A] | No se usa. |
| [!UICONTROL Informe Breve De Resumen De Uso Del Panel De R&amp;A] | No se usa. |
