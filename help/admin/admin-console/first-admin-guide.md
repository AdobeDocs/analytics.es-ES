...
Los administradores de nivel de sistema no tienen acceso directo a los productos; sin embargo, pueden acceder a ellos mismos añadiéndose como administradores de nivel de producto. Si desea que usted u otros usuarios tengan acceso a Adobe Analytics, puede seguir estos pasos.

1. Inicie sesión en [Admin Console](https://adminconsole.adobe.com/) con sus credenciales de Adobe ID.
1. Haga clic en la ficha Productos en la parte superior. Todos los productos comprados por su organización están a la izquierda. Haga clic en Adobe Analytics y, a continuación, en el botón Nuevo perfil.
1. Asigne a este perfil el nombre "Acceso de administrador completo de Analytics" y, a continuación, haga clic en Finalizado.
...
1. En el mosaico de Adobe Analytics, haga clic en 'Asignar usuarios'.
...
## Concesión de acceso de administrador de producto para el lanzamiento de la plataforma de experiencia

El acceso de administrador de productos para el lanzamiento de la plataforma de experiencia es casi idéntico al acceso de administrador de productos para Analytics.

1. Inicie sesión en Admin Console con sus credenciales de Adobe ID.
1. Haga clic en la ficha Productos en la parte superior. Todos los productos comprados por su organización están a la izquierda. Haga clic en Inicio de plataforma de experiencia por Adobe y, a continuación, haga clic en el botón Nuevo perfil.
1. Asigne un nombre a este perfil "Acceso de administrador completo de Experience Platform Launch" y, a continuación, haga clic en Finalizado.
1. Vuelva a la página Perfiles de producto, haga clic en el perfil recién creado y, a continuación, haga clic en la ficha Permisos.
1. Haga clic en uno de los elementos de la línea de permisos. Si la inclusión automática está disponible, habilite la opción. Si la inclusión automática no está disponible, haga clic en Agregar todo. Ambas opciones mueven todos los elementos de permiso a la columna derecha.
1. Haga clic en Guardar. Repita el paso anterior para todas las categorías de permisos.
1. Una vez que todas las categorías de permisos se hayan concedido al perfil, vuelva a la página Información general haciendo clic en Información general en la parte superior.
...
[Crear un grupo](create-report-suite.md)de informes: Haga que el administrador de Analytics inicie sesión en la herramienta y cree un grupo de informes para la recopilación de datos

[Cree una propiedad en Inicio](/help/implement/implement-with-launch/create-analytics-property.md)de plataforma de experiencia: Haga que el administrador de Experience Platform Launch inicie sesión en la herramienta y cree una propiedad para implementarla en el sitio
