...
seo-description: Define la configuración común de bancos y otras instituciones que proporcionan acceso a servicios en línea.
seo-title: Servicios financieros
solution: Analytics
...
| Variables de conversión (eVars) | Tipo | Subrelaciones | Asignación | Vencimiento | `s_code` correspondiente |
|---|---|---|---|---|---|
