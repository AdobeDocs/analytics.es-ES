...
* Cambio de `2o7.net` a `omtrdc.net` ([recopilación de datos regionales](https://marketing.adobe.com/resources/help/es_ES/whitepapers/rdc/)).

* Está implementando el [servicio de ID de visitante de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/mcvid/) y está pasando de un dominio de recopilación de datos CNAME o de origen a `2o7.net` o `omtrdc.net` ([recopilación de datos regionales](https://marketing.adobe.com/resources/help/es_ES/whitepapers/rdc/))

* Migración de `2o7.net` o `omtrdc.net` a una recopilación de datos de cname o de origen ([Cookies de origen)](https://marketing.adobe.com/resources/help/es_ES/whitepapers/first_party_cookies/).
...
<table id="table_7B2535FC3E264216A299686415C6B21C"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <b>Para comenzar:</b> Póngase en <a href="https://helpx.adobe.com/es/marketing-cloud/contact-support.html" format="http" scope="external">contacto con el Servicio de atención al cliente</a> y especifique el o los dominios que desea migrar, así como el período de migración que desea habilitar (30, 60 o 90 días). Asegúrese de incluir los dominios seguros y no seguros. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Después de realizar este cambio, utilice un <a href="../../implement/impl-testing/packet-monitor.md#concept_490DF35E06D44234A91B5FC57C0BF258" format="dita" scope="local">Analizador de paquetes</a> para comprobar que la solicitud de imagen de Analytics va al servidor de recopilación de datos actualizado. </p> </td> 
  </tr> 
  <tr> 
