...
| `lrt` | Ninguna | El &quot;último tiempo de solicitud&quot;, que es el tiempo de ida y vuelta para la última solicitud, en milisegundos. Solo se envía cuando se produce más de una solicitud desde una página o cuando la página es una aplicación de una sola página (SPA). |
