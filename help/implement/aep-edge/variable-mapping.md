...
| `_experience.analytics.customDimensions.`<br/>`lists.list1.list` -<br/>`_experience.analytics.customDimensions.`<br/>`lists.list3.list` | Establece la respectiva [Variable de lista](../vars/page-vars/list.md). |
