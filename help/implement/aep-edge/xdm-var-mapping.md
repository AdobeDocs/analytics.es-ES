...
| `xdm.media.mediaTimed.midpoints.value` | El marcador de progreso del 50 % [ de la métrica de medios de streaming.](https://experienceleague.adobe.com/en/docs/media-analytics/using/implementation/variables/audio-video-parameters#progress-marker) |
