...
seo-title: Configurar las opciones de alojamiento
solution: Analytics
...
Para obtener información detallada sobre el alojamiento, consulte [Opciones de código incrustado y alojamiento](https://marketing.adobe.com/resources/help/es_ES/dtm/deployment.html) en la documentación del producto de [!UICONTROL Dynamic Tag Management].
