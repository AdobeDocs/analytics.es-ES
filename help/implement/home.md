...
* **API de Edge Network**: implementa código en el servidor que usa la API de Adobe Experience Platform Edge Network para comunicarse con Adobe Analytics a través de una secuencia de datos.
