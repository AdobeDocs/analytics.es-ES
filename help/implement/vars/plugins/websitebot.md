...
* **Configuración de eVar**: configure un eVar en [Variables de conversión](/help/admin/admin/conversion-var-admin/conversion-var-admin.md) en la configuración del grupo de informes. Establezca la caducidad en **Never** y la asignación en **&quot;Valor original (primero)&quot;**.
...
1. Agregue una regla de llamada directa que active una señalización de Analytics con `websiteBot` como identificador. En este ejemplo utiliza una llamada `s.tl`:

   ![identificador de websiteBot](assets/websitebot.png)

1. Active las acciones Adobe Analytics - Set Variables &amp; Adobe Analytics - Send Beacon en la regla Direct Call .  En el siguiente ejemplo se muestra una forma de hacerlo:
