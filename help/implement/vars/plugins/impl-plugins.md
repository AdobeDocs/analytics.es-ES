...
1. Primero cree una instancia del objeto de seguimiento de Analytics (use [`s_gi`](../functions/s-gi.md)).
   * El sitio habilitado para etiquetas crea automáticamente una instancia del objeto de seguimiento cuando se carga Adobe Analytics.
...
3. Tercero, llame al complemento.
   * Todas las implementaciones, tanto dentro como fuera de un sitio habilitado para etiquetas, utilizan JavaScript para llamar a los complementos. Llame al complemento con el formato documentado en la página de dicho complemento.
