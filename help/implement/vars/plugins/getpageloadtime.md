...
>[!IMPORTANT]
>
>Este complemento ya no es compatible. Su código utiliza el método performance.timing, que (según MDN) se ha [obsoleto](https://developer.mozilla.org/en-US/docs/Web/API/PerformanceTiming).
