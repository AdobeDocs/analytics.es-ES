...
Adobe ofrece varias formas de implementar Adobe Analytics. Cada página ofrece una sección sobre cómo implementar la variable mediante la SDK web, utilizando la extensión de Adobe Analytics y AppMeasurement para JavaScript.


>[!BEGINSHADEBOX]

Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Configuración de variables](https://video.tv.adobe.com/v/28755?quality=12&learn=on){target="_blank"} para ver un vídeo de demostración.
