...
* **Las variables** de página son valores que generalmente se utilizan directamente en los informes. Las variables de página comunes incluyen `props`, `eVars`y `events`.
...
Algunas variables tienen limitaciones o requisitos de sintaxis adicionales. Por ejemplo, la `products` variable reserva punto y coma para delimitar productos y categorías independientes.
