...
La extensión del SDK web proporciona una lista desplegable de Datastream para cada entorno. Como alternativa, puede introducir manualmente el ID de almacén de datos.
