...
4. Configure las variables [!UICONTROL Extensión] lista desplegable a **[!UICONTROL Principal]** y [!UICONTROL Tipo de elemento de datos] a **[!UICONTROL Parámetro de cadena de consulta]**.
