...
* Si utiliza etiquetas en Adobe Experience Platform, los grupos de informes residen en el acordeón [!UICONTROL Administración de biblioteca] al configurar la extensión de Adobe Analytics.
