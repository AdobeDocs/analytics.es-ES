...
>[!NOTE]
>
>Se puede guardar un solo valor único en una eVar de una solicitud de imagen. Si quiere que haya varios valores en un valor eVar, le recomendamos que implemente [Variables de lista](/help/implement/js-implementation/c-variables/page-variables.md).
...
* [Variables: su uso en informes](https://marketing.adobe.com/resources/help/es_ES/reference/variable_definitions.html)
...
* [Variable Products](https://marketing.adobe.com/resources/help/es_ES/mobile/android/products.html) en la documentación del SDK móvil
